       ...
       return (
              <AppLayout>
                     ...
                     <div className="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                            <div className="bg-white text-gray-900 overflow-hidden shadow-xl sm:rounded-lg p-6 sm:p-10">
                                   <div className="elementor-widget-container para">
                                          <h1 className="text-3xl font-bold mb-6">Terms and Conditions for Xpert Bid: The Best Auction in Town</h1>

                                          <p className="mb-4 text-gray-600">Last updated: July 28, 2025</p>
                                          ...
                                          <ul className="list-disc pl-6 mb-4 space-y-2">
                                                 ...
                                                 <li>
                                                        <p>
                                                               ...
                                                               &quot;Our&quot; in this Agreement) refers to Xpertbid Auctions Organizing LLC, Office # 2F.031 ,
                                                               Fahad Ahmad Building, Street # 13B - Hor Al Anz - Dubai - United Arab Emirates.
                                                        </p>
                                                 </li>
                                                 <li>
                                                 ...
                                                 <li>
                                                        <p>
                                                               <strong>Website</strong> refers to Xpert Bid: The Best Auction in Town, accessible from{" "}
                                                               <strong>
                                                                      <a href="https://www.xpertbid.com/" target="_blank" rel="noopener nofollow" className="text-blue-600 hover:text-blue-800">
                                          ...
                                          <h2 className="my-4">Acknowledgment</h2>
                                          <p>
                                          ...
                                          <h2 className="my-4">Links to Other Websites</h2>
                                          <p>
                                          ...
                                          <h2 className="my-4">Termination</h2>
                                          <p>
                                          ...
                                          <h2 className="my-4">Limitation of Liability</h2>
                                          <p>
                                          ...
                                          <h2 className="my-4">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
                                          <p>
                                          ...
                                          <h2 className="my-4">Governing Law</h2>
                                          <p>
                                          ...
                                          <h2 className="my-4">United States Legal Compliance</h2>
                                          <p>
                                          ...
                                          <h2 className="my-4">Severability and Waiver</h2>

                                          <h3 className="my-4">Severability</h3>
                                          <p>
                                          ...
                                          <h2 className="my-4">Translation Interpretation</h2>
                                          <p>
                                          ...
                                          <h2 className="my-4">Changes to These Terms and Conditions</h2>
                                          <p>
