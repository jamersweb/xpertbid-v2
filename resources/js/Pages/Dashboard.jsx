            ...
            <div style={{ backgroundColor: '#F9F9F9', minHeight: '100vh' }}>
                <section className="dashboard-records py-4">
                    <div className="container">
                        <div className="row">
                            <h1 className="mkt-sec mb-4 px-3" style={{ fontSize: '32px', fontWeight: '800', color: '#23262F' }}>Dashboard</h1>
                ...
                <div className="container">
                    <div className="d-flex justify-content-between align-items-center mx-4 px-3">
                        <h2 className="mb-0" style={{ fontSize: '34px', fontWeight: '700', color: '#23262F' }}>My Listings</h2>
