                                                 ...
                                                 {listings.data.map((listing) => (
                                                        <tr key={listing.id} className="hover:bg-gray-50/50 transition-colors">
                                                                <td className="px-6 py-4">
                                                                       <div className="flex items-center gap-3">
                                                                              ...
                                                                              <div>
                                                                                     ...
                                                                                     <p className="text-[10px] text-gray-400">ID: {listing.id} | Type: <span className="uppercase">{listing.listing_type}</span></p>
                                                                              </div>
                                                                       </div>
                                                                </td>
                                                               <td className="px-6 py-4">
                                                               ...
                                                               <td className="px-6 py-4">
                                                                ...
                                                                <td className="px-6 py-4">
                                                                       <p className="text-sm font-bold text-black">{listing.listing_type === 'auction' ? listing.minimum_bid : (listing.buy_now_price || listing.minimum_bid)}</p>
                                                                       <p className="text-[10px] text-gray-400">Stock: {listing.listing_data?.stock ?? 'N/A'}</p>
                                                                </td>
                                                               <td className="px-6 py-4">
                                                                      <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${statusBadges[listing.status] || 'bg-gray-100'}`}>
                                                                             {listing.status}
                                                                      </span>
                                                               </td>
                                                               <td className="px-6 py-4 text-right">
                                                                      <div className="flex items-center justify-end gap-2">
                                                                             ...
                                                                             <button onClick={() => { if (confirm('Delete this listing?')) router.delete(route('admin.listings.destroy', listing.id)) }} className="p-2 hover:bg-rose-50 rounded-lg text-rose-600 transition-colors" title="Delete"><i className="fa-solid fa-trash"></i></button>
                                                                      </div>
                                                               </td>
                                                        </tr>
                                                 ))}
