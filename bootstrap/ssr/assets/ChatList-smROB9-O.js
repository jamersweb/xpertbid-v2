  ...
  const fetchConversations = async () => {
    try {
      const response = await axios.get(route("chat.conversations.index"), {
        params: isAdminView ? { admin_view: 1, participant_id: participantId || void 0 } : {}
      });
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-baseline mb-0.5", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-gray-900 truncate", children: isAdminView ? `${conv.user_one?.name || "Unknown"} -> ${conv.user_two?.name || "Unknown"}` : conv.other_user?.name || "Unknown User" }),
              ...
              /* @__PURE__ */ jsx("div", { className: "text-[10px] text-gray-400 mb-1", children: getLastSeen(isAdminView ? conv.user_two?.last_active_at : conv.other_user?.last_active_at) === "Online" ? /* @__PURE__ */ jsx("span", { className: "text-green-500 font-medium", children: "Online" }) : /* @__PURE__ */ jsx("span", { children: getLastSeen(isAdminView ? conv.user_two?.last_active_at : conv.other_user?.last_active_at) }) }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                ...
                !isAdminView && /* @__PURE__ */ jsxs("div", { className: "relative dropdown-trigger", children: [
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      onClick: (e) => {
