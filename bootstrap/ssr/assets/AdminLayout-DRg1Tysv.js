...
function AdminSidebar({ isOpen, setIsOpen }) {
  ...
  return /* @__PURE__ */ jsxs(
    "aside",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "h-16 flex items-center justify-center border-bottom border-gray-100 px-4", children: /* @__PURE__ */ jsxs(Link, { href: route("admin.dashboard"), className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("img", { src: "/assets/images/header-logo.png", alt: "Logo", className: `${isOpen ? "h-10" : "h-8"} transition-all` }),
          isOpen && /* @__PURE__ */ jsx("span", { className: "font-bold text-lg tracking-tight", children: "ADMIN" })
        ] }) }),
      ...
      /* @__PURE__ */ jsxs("header", { className: "h-16 bg-white border-bottom border-gray-200 sticky top-0 z-30 px-6 flex items-center justify-between shadow-sm", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("img", { src: "/assets/images/header-logo.png", alt: "XpertBid", className: "h-8" }),
            /* @__PURE__ */ jsx("span", { className: "text-gray-300 mx-1", children: "|" }),
            /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-gray-800", children: title })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex items-center gap-4", children: /* @__PURE__ */ jsx("div", { className: "relative group", children: /* @__PURE__ */ jsxs("button", { className: "flex items-center gap-2 p-1.5 hover:bg-gray-50 rounded-xl transition-colors border border-gray-100", children: [
