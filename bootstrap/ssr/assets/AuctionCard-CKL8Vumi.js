...
const AuctionCard = ({ auction, activeTab = "active", showPropertyMeta = false }) => {
  ...
  const displayLabel = isWonAuction ? "Winning Bid" : isDirectBuyListing ? "Price" : isLiveAuction ? hasMaxBid ? "Live Bid" : "Start Price" : hasMaxBid ? "Current Bid" : "Minimum Bid";
  return /* @__PURE__ */ jsxs("div", { className: "product-card-wrapper h-100", children: [
    /* @__PURE__ */ jsxs("div", { className: "pro-image m-0", style: { position: "relative" }, children: [
      ...
      !isWonAuction && !isDirectBuyListing && !isLiveAuction && /* @__PURE__ */ jsx(CountdownTimer, { startDate: auction.start_date, endDate: auction.end_date })
    ] }),
    /* @__PURE__ */ jsx(
      OwnerInfoRow,
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: "pro-meta", children: [
      ...
      ) : /* @__PURE__ */ jsx("div", { className: "pro-bid-btn", children: /* @__PURE__ */ jsx(Link, { href: `/product/${auction.slug}`, children: isDirectBuyListing ? "Buy Now" : isLiveAuction ? "Join Live" : "Place Bid" }) }) })
    ] })
  ] });
};
export {
