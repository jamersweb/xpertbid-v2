...
function Login({ status, canResetPassword }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Log in", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "container-fluid py-5", style: { background: "#f8f9fa", minHeight: "80vh" }, children: [
      step === "main" && /* @__PURE__ */ jsxs("div", { className: "login-form-step text-center", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "mt-4 text-muted small", children: [
          ...
          /* @__PURE__ */ jsx(Link, { href: route("terms"), className: "text-decoration-underline text-primary", children: "Terms of service" }),
          " and ",
          /* @__PURE__ */ jsx(Link, { href: route("privacy.policy"), className: "text-decoration-underline text-primary", children: "Privacy policy" }),
          "."
        ] })
      ] }),
      step === "email" && /* @__PURE__ */ jsxs("div", { className: "login-form-step", children: [
        /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
          ...
          /* @__PURE__ */ jsx("h3", { children: "Login with Email" })
        ] }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "auth-input-group", children: [
          ...
          /* @__PURE__ */ jsx("button", { className: "form-button-1", disabled: processing, children: processing ? "Logging in..." : "Continue" }),
          /* @__PURE__ */ jsxs("div", { className: "text-center mt-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted small", children: "Don't have an account? " }),
            /* @__PURE__ */ jsx(Link, { href: route("register"), className: "small fw-bold text-dark text-decoration-underline", children: "Register" })
          ] })
        ] })
      ] }),
      step === "phone" && /* @__PURE__ */ jsxs("div", { className: "login-form-step", children: [
        /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
          ...
          /* @__PURE__ */ jsxs("h3", { children: [
            "Login with ",
            phoneData.otp_type === "whatsapp" ? "WhatsApp" : "Phone"
          ] })
        ] }),
