...
import { g as getCategoryBrowseUrl, A as AppLayout } from "./AppLayout-DGCnkUrN.js";
...
import { a as isDirectBuyListing, i as isSoldOutListing, e as getCardDisplayPrice } from "./listingPricing-AMeF2Tun.js";
import { b as buildProductHref } from "./productUrl-DG64MGAp.js";
      ...
      /* @__PURE__ */ jsx(
        Swiper,
        {
          ...
          children: displayCategories.map((cat, i) => /* @__PURE__ */ jsx(SwiperSlide, { className: "category-item-wrapper", children: (() => {
            ...
            if (browse.external) {
              return /* @__PURE__ */ jsx("a", { href: browse.href, className, target: "_blank", rel: "noopener noreferrer", children: content });
            }
            return /* @__PURE__ */ jsx(Link, { href: browse.href, className, children: content });
          })() }, cat.id || i))
        }
      )
    ] }),
...
function HomeCategorySection({ title, products, viewAllHref, viewAllExternal = false }) {
  const { t } = useTranslate();
  const displayProducts = (products || []).slice(0, 3);
  if (displayProducts.length < 3) return null;
  const sectionTitle = title || "Latest Listings";
  const href = viewAllHref || "/marketplace";
  return /* @__PURE__ */ jsx("section", { className: "featured-product", style: { backgroundColor: "#F9F9F9" }, children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxs("div", { className: "home-section-header", children: [
      /* @__PURE__ */ jsx("div", { className: "featured-heading mb-0", children: /* @__PURE__ */ jsx("h2", { children: sectionTitle }) }),
      viewAllExternal ? /* @__PURE__ */ jsx("a", { href, className: "section-view-all-btn", target: "_blank", rel: "noopener noreferrer", children: t("View All") }) : /* @__PURE__ */ jsx(Link, { href, className: "section-view-all-btn", children: t("View All") })
    ] }),
...
function Home({
  ...
  return /* @__PURE__ */ jsx(AppLayout, { title: t("Online Auction Marketplace Pakistan | Bid & Sell on XpertBid"), children: /* @__PURE__ */ jsxs("div", { className: "home-page overflow-x-hidden", children: [
    ...
    (categorySections || []).map((section) => {
      ...
      const viewAllHref = browse.href || (slug ? `/marketplace/${encodeURIComponent(slug)}` : "/marketplace");
      return /* @__PURE__ */ jsx(
        HomeCategorySection,
        {
          title: name,
