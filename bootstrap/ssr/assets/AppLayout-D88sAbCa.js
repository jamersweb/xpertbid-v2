...
import { u as useTranslate, C as CurrencyPicker } from "./CurrencyPicker-KgG9a2BI.js";
function CartPopup() {
...
function DesktopCategoriesDropdown() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dropdown", ref: dropdownRef, children: [
    ...
    /* @__PURE__ */ jsx("ul", { className: "dropdown-menu", "aria-labelledby": "categoriesDropdown", children: categories.map((cat) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
      Link,
      {
        href: route$1("marketplace.type", { slug: cat.slug, typeSlug: "auctions" }),
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleEmailLogin, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "d-flex justify-content-between align-items-center mb-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "form-check mb-0", children: [
            ...
            /* @__PURE__ */ jsx("label", { className: "form-check-label small text-muted ms-2", htmlFor: "rememberMe", style: { paddingTop: "1px" }, children: t("auth.remember_me") })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
            {
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-100", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "xp-brand-top-banner", "aria-label": "XpertBid brand banner", children: [
        /* @__PURE__ */ jsxs("div", { className: "xp-brand-links", children: [
          /* @__PURE__ */ jsx(Link, { className: "xp-brand-link", href: "/marketplace/real-estate-property-auction?type=auction", "aria-label": "View property marketplace", children: /* @__PURE__ */ jsx("img", { className: "xp-brand-logo xp-brand-logo-prop", src: "/assets/images/xp-prop-logo-clean.png", alt: "XpertBid Property" }) }),
          ...
          /* @__PURE__ */ jsx(Link, { className: "xp-brand-link", href: "/marketplace/mandi", "aria-label": "View mandi marketplace", children: /* @__PURE__ */ jsx("img", { className: "xp-brand-logo xp-brand-logo-mandi", src: "/assets/images/xp-mandi-logo-clean.svg", alt: "XpertBid Mandi" }) })
        ] }),
