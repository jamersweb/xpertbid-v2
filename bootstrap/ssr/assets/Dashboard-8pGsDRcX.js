...
import { L as ListingCard } from "./ListingCard-CJY8Wtib.js";
import "ziggy-js";
import "react";
...
function Dashboard({ listingsCount, biddingsCount, listings }) {
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Dashboard", children: [
    /* @__PURE__ */ jsx(Head, { title: "User Dashboard" }),
    /* @__PURE__ */ jsxs("div", { style: { backgroundColor: "#F9F9F9", minHeight: "100vh" }, children: [
      /* @__PURE__ */ jsx("section", { className: "dashboard-records py-4", children: /* @__PURE__ */ jsx("div", { className: "container", children: /* @__PURE__ */ jsxs("div", { className: "row", children: [
        /* @__PURE__ */ jsx("h1", { className: "mkt-sec mb-4 px-3", style: { fontSize: "32px", fontWeight: "800", color: "#23262F" }, children: "Dashboard" }),
      ...
      /* @__PURE__ */ jsx("div", { className: "container", children: /* @__PURE__ */ jsxs("div", { className: "d-flex justify-content-between align-items-center mx-4 px-3", children: [
        /* @__PURE__ */ jsx("h2", { className: "mb-0", style: { fontSize: "34px", fontWeight: "700", color: "#23262F" }, children: "My Listings" }),
        /* @__PURE__ */ jsx(Link, { className: "button-style-3", href: route("auctions.mylistings"), children: "See all" })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "listing pb-5", children: /* @__PURE__ */ jsx("div", { className: "container dashboard-listing", children: /* @__PURE__ */ jsx("div", { className: "row g-4", children: listings && listings.length > 0 ? listings.map((listing) => /* @__PURE__ */ jsx("div", { className: "col-12 px-3", children: /* @__PURE__ */ jsx(ListingCard, { listing }) }, listing.id)) : /* @__PURE__ */ jsx("div", { className: "col-12 text-center py-5", children: /* @__PURE__ */ jsx("p", { className: "text-muted", children: "No listings available." }) }) }) }) })
    ] })
  ] });
}
export {
