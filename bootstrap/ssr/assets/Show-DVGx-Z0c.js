...
import { A as AdminLayout } from "./AdminLayout-BftjA1Zj.js";
...
function Show({ listing }) {
  ...
  const renderMediaPreview = (value, label) => {
    const items = (Array.isArray(value) ? value : [value]).map(resolveMediaUrl).filter(Boolean);
    if (!items.length) {
      return /* @__PURE__ */ jsxs("p", { className: "mt-1 text-sm text-gray-500", children: [
        "No ",
        label.toLowerCase(),
        " available"
      ] });
    }
    return /* @__PURE__ */ jsx("div", { className: "mt-3 grid grid-cols-2 md:grid-cols-3 gap-3", children: items.map((src, index) => /* @__PURE__ */ jsx(
      "a",
      {
        href: src,
        target: "_blank",
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: `Listing Details: ${listing.title}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          pendingEdit && /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: "Approve Pending Edits"
            }
          ),
      ...
      pendingEdit && /* @__PURE__ */ jsxs("div", { className: "bg-amber-50 border border-amber-200 text-amber-900 p-4 rounded-2xl", children: [
        /* @__PURE__ */ jsx("p", { className: "text-sm font-bold uppercase tracking-wider", children: "Pending Edits" }),
        /* @__PURE__ */ jsx("p", { className: "text-sm mb-0 mt-1", children: "This listing has seller changes waiting for admin approval. The frontend is still showing the current live data until you merge these edits." })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
          ...
          pendingEdit && /* @__PURE__ */ jsxs("div", { className: "bg-white text-gray-900 p-6 rounded-2xl shadow-sm border border-amber-200", children: [
            /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-gray-900 mb-4", children: "Pending Edit Preview" }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-700", children: "Main fields" }),
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-700", children: "Pending listing_data" }),
                renderStructuredData(pendingEdit.listing_data)
              ] }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-700", children: "Pending category_features" }),
