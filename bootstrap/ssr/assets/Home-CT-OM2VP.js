...
import { a as isDirectBuyListing, i as isSoldOutListing, g as getDiscountMeta, c as isBusinessListing, b as getBaseListingPrice } from "./listingPricing-C5UuJtWm.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "container-fluid", children: [
      ...
      /* @__PURE__ */ jsx(
        Swiper,
        {
          ...
          children: displayCategories.map((cat, i) => /* @__PURE__ */ jsx(SwiperSlide, { className: "category-item-wrapper", children: (() => {
            ...
            return /* @__PURE__ */ jsxs(
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: `image-circle ${hasIcon ? "has-icon" : ""}`, children: /* @__PURE__ */ jsx(
                    "img",
                    {
                      src: assetSrc(media),
                      alt: cat.name,
...
function SliderBrowseBrands({ brands = [] }) {
  const { t } = useTranslate();
  ...
  return /* @__PURE__ */ jsxs("section", { className: "browsebrands", style: { backgroundColor: "#F7F8F9" }, children: [
    /* @__PURE__ */ jsxs("div", { className: "container-fluid", children: [
      /* @__PURE__ */ jsxs("div", { className: "home-section-header mb-3", children: [
        /* @__PURE__ */ jsx("div", { className: "featured-heading mb-0", children: /* @__PURE__ */ jsx("h2", { children: t("Brands") }) }),
        /* @__PURE__ */ jsx(Link, { href: route("brands.page"), className: "section-view-all-btn", children: t("View All") })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "brand-grid", children: displayBrands.map((brand, i) => /* @__PURE__ */ jsx(
        Link,
        {
...
function FeaturedProducts({ products }) {
  ...
  return /* @__PURE__ */ jsx("section", { className: "featured-product", children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxs("div", { className: "home-section-header", children: [
      ...
      /* @__PURE__ */ jsx(Link, { href: "/marketplace?featured=home_featured&section=featured", className: "section-view-all-btn", children: t("View All") })
    ] }),
    displayProducts.length > 0 ? /* @__PURE__ */ jsx("div", { className: "row g-4 home-mobile-scroll-row", children: displayProducts.map((product, index) => {
      ...
      return /* @__PURE__ */ jsx("div", { className: "col-12 col-sm-6 col-lg-4", children: /* @__PURE__ */ jsxs("div", { className: "product-card-wrapper h-100", children: [
        /* @__PURE__ */ jsxs("div", { className: "pro-image", style: { position: "relative" }, children: [
          ...
          /* @__PURE__ */ jsx(Link, { href: buildProductHref(product.slug), className: "product-box", children: /* @__PURE__ */ jsx("div", { className: "relative aspect-[4/3] w-full overflow-hidden", children: /* @__PURE__ */ jsx(
            "img",
            {
              src: imageSrc,
        ...
        /* @__PURE__ */ jsx("div", { className: "pro-title", style: { color: "black" }, children: /* @__PURE__ */ jsx("h2", { children: /* @__PURE__ */ jsx(Link, { href: buildProductHref(product.slug), className: "text-color-black", children: product.title }) }) }),
...
function VehicleSection({ products }) {
  ...
  return /* @__PURE__ */ jsx("section", { className: "featured-product", style: { backgroundColor: "#F9F9F9" }, children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxs("div", { className: "home-section-header", children: [
      ...
      /* @__PURE__ */ jsx(Link, { href: "/marketplace/vehicles?type=auction&section=latest_vehicles", className: "section-view-all-btn", children: t("View All") })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "row g-4 home-mobile-scroll-row", children: displayProducts.map((product, index) => {
      ...
      return /* @__PURE__ */ jsx("div", { className: "col-12 col-sm-6 col-lg-4", children: /* @__PURE__ */ jsxs("div", { className: "product-card-wrapper h-100", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "pro-title", style: { color: "black" }, children: /* @__PURE__ */ jsx("h2", { children: /* @__PURE__ */ jsx(Link, { href: buildProductHref(product.slug), className: "text-color-black", children: product.title || product.name }) }) }),
        /* @__PURE__ */ jsxs("div", { className: "pro-meta", children: [
          /* @__PURE__ */ jsxs("div", { className: "pro-price", children: [
            /* @__PURE__ */ jsx("span", { children: directBuyListing ? t("Price") : hasMaxBid ? t("Current Bid") : t("Minimum Bid") }),
...
function PropertySection({ products }) {
  ...
  return /* @__PURE__ */ jsx("section", { className: "featured-product", children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxs("div", { className: "home-section-header", children: [
      ...
      /* @__PURE__ */ jsx(Link, { href: "/marketplace/real-estate-property-auction?type=auction&section=latest_properties", className: "section-view-all-btn", children: t("View All") })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "row g-4 home-mobile-scroll-row", children: displayProducts.map((product, index) => {
      const maxBid = Number(product?.bids_max_bid_amount ?? 0);
      const minBid = Number(product?.minimum_bid ?? 0);
...
function AuctionSection({ products, title = "Latest Auctions", viewAllHref = "/marketplace?type=auction&section=latest_auctions" }) {
  const { t } = useTranslate();
  const displayProducts = (products || []).slice(0, 3);
  if (displayProducts.length === 0) return null;
  return /* @__PURE__ */ jsx("section", { className: "featured-product", style: { backgroundColor: "#F9F9F9" }, children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxs("div", { className: "home-section-header", children: [
      /* @__PURE__ */ jsx("div", { className: "featured-heading mb-0", children: /* @__PURE__ */ jsx("h2", { children: t(title) }) }),
      /* @__PURE__ */ jsx(Link, { href: viewAllHref, className: "section-view-all-btn", children: t("View All") })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "row g-4 home-mobile-scroll-row", children: displayProducts.map((product, index) => {
      ...
      return /* @__PURE__ */ jsx("div", { className: "col-12 col-sm-6 col-lg-4", children: /* @__PURE__ */ jsxs("div", { className: "product-card-wrapper h-100", children: [
        /* @__PURE__ */ jsxs("div", { className: "pro-image", style: { position: "relative" }, children: [
          ...
          !isLiveAuction && /* @__PURE__ */ jsx(CountdownTimer, { startDate: product.start_date, endDate: product.end_date })
        ] }),
        /* @__PURE__ */ jsx(
          OwnerInfoRow,
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "pro-title", style: { color: "black" }, children: /* @__PURE__ */ jsx("h2", { children: /* @__PURE__ */ jsx(Link, { href: buildProductHref(product.slug), className: "text-color-black", children: product.title || product.name || "Untitled" }) }) }),
        /* @__PURE__ */ jsxs("div", { className: "pro-meta", children: [
          /* @__PURE__ */ jsxs("div", { className: "pro-price", children: [
            /* @__PURE__ */ jsx("span", { children: isLiveAuction ? hasMaxBid ? t("Live Bid") : t("Start Price") : hasMaxBid ? t("Current Bid") : t("Minimum Bid") }),
          ...
          /* @__PURE__ */ jsx("div", { className: "pro-buy-btn", children: /* @__PURE__ */ jsx("div", { className: "pro-bid-btn", children: /* @__PURE__ */ jsx(Link, { href: buildProductHref(product.slug), children: isLiveAuction ? t("Join Live") : t("Place Bid") }) }) })
        ] })
      ] }) }, `${product.slug}-${index}`);
    }) })
  ] }) });
...
function NormalListSection({ products }) {
  ...
  return /* @__PURE__ */ jsx("section", { className: "featured-product", children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
    /* @__PURE__ */ jsxs("div", { className: "home-section-header", children: [
      ...
      /* @__PURE__ */ jsx(Link, { href: "/marketplace?type=normal&section=latest_listings", className: "section-view-all-btn", children: t("View All") })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "row g-4 home-mobile-scroll-row", children: displayProducts.map((product, index) => {
      ...
      return /* @__PURE__ */ jsx("div", { className: "col-12 col-sm-6 col-lg-4", children: /* @__PURE__ */ jsxs("div", { className: "product-card-wrapper h-100", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "pro-meta", children: [
          /* @__PURE__ */ jsxs("div", { className: "pro-price", children: [
            /* @__PURE__ */ jsx("span", { children: businessListing ? t("Business Price") : t("Price") }),
            /* @__PURE__ */ jsx("div", { className: "price", children: /* @__PURE__ */ jsx("span", { className: "me-1", style: { color: "#23262F" }, children: (() => {
              if (discountMeta.hasDiscount) {
                return /* @__PURE__ */ jsxs("span", { className: "d-flex align-items-center gap-2", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-decoration-line-through text-muted fs-6", style: { fontSize: "0.8em" }, children: /* @__PURE__ */ jsx(Price, { amountAED: discountMeta.originalPrice }) }),
                  /* @__PURE__ */ jsx("span", { className: "text-danger fw-bold", children: /* @__PURE__ */ jsx(Price, { amountAED: discountMeta.finalPrice }) })
                ] });
              }
              return /* @__PURE__ */ jsx(Price, { amountAED: price });
            })() }) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "pro-buy-btn", children: /* @__PURE__ */ jsx("div", { className: "pro-bid-btn", children: isSoldOut ? /* @__PURE__ */ jsx("span", { style: { display: "inline-flex", alignItems: "center", justifyContent: "center", borderRadius: "12px", padding: "14px 22px", background: "#9ca3af", color: "#fff", fontWeight: 600, cursor: "not-allowed" }, children: t("Sold Out") }) : /* @__PURE__ */ jsx(Link, { href: buildProductHref(product.slug), children: businessListing ? t("View Product") : t("Buy Now") }) }) })
        ] })
      ] }) }, `${product.slug}-${index}`);
    }) })
  ] }) });
...
function Home({ auth, sliders, brands, categories, featuredAuctions, latestAuctions, latestLiveAuctions, latestVehicles, latestProperties, latestNormalLists, favoriteListingIds }) {
  ...
  return /* @__PURE__ */ jsx(AppLayout, { title: t("Online Auction Marketplace Pakistan | Bid & Sell on XpertBid"), children: /* @__PURE__ */ jsxs("div", { className: "home-page overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsx(SliderBrowseBrands, { brands }),
