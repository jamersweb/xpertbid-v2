...
import { A as AppLayout, g as getCategoryBrowseUrl } from "./AppLayout-DGCnkUrN.js";
...
function Index({
  ...
  const handleCategoryTabChange = (slug) => {
    const matchedCategory = categories.find((category) => category.slug === slug) || subcategoryTabs.find((category) => category.slug === slug) || childCategoryTabs.find((category) => category.slug === slug) || (currentCategory?.slug === slug ? currentCategory : null) || (currentTopCategory?.slug === slug ? currentTopCategory : null) || { slug };
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: currentCategory?.meta_title || "Marketplace", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "pb-5 bg-light min-vh-100", children: [
      ...
      isFilterDrawerMounted && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("aside", { className: `marketplace-filter-drawer ${isFilterDrawerOpen ? "is-open" : ""}`, children: [
