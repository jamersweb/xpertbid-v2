...
import { a as isDirectBuyListing, i as isSoldOutListing, g as getDiscountMeta } from "./listingPricing-AMeF2Tun.js";
...
const FavoriteCard = ({ favorite }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "col-lg-4 col-md-6 col-sm-12 mkt-child", children: /* @__PURE__ */ jsxs("div", { className: "market-card", children: [
    /* @__PURE__ */ jsxs("div", { className: "mkt-img", children: [
      /* @__PURE__ */ jsx(Link, { href: buildProductHref(favorite.slug), className: "product-box", children: /* @__PURE__ */ jsx(
        "img",
        {
          src: imgPath,
          alt: title,
    ...
    /* @__PURE__ */ jsxs("div", { className: "mkt-body", children: [
      /* @__PURE__ */ jsx("div", { className: "mkt-pro-head", children: /* @__PURE__ */ jsx("h3", { children: /* @__PURE__ */ jsx(Link, { href: buildProductHref(favorite.slug), children: title }) }) }),
      /* @__PURE__ */ jsx(
        OwnerInfoRow,
        {
