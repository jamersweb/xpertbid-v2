...
function Corporate({ verifications, filters }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Corporate Verifications", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "p-6 border-bottom border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-4", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSearch, className: "flex-1 max-w-md relative", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-100", children: verifications.data.map((verification) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50 transition-colors", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("div", { className: "flex gap-1 flex-wrap max-w-[150px]", children: (verification.business_documents || []).map((doc, idx) => /* @__PURE__ */ jsxs("a", { href: "/" + doc, target: "_blank", className: "text-[10px] bg-gray-100 hover:bg-gray-200 px-2 py-1 rounded", children: [
            "Doc ",
            idx + 1
          ] }, idx)) }) }),
