...
import { C as CountdownTimer, O as OwnerInfoRow } from "./OwnerInfoRow-Bp3cN_Xd.js";
...
const FavoriteCard = ({ favorite }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "col-lg-4 col-md-6 col-sm-12 mkt-child", children: /* @__PURE__ */ jsxs("div", { className: "market-card", children: [
    /* @__PURE__ */ jsxs("div", { className: "mkt-img", children: [
      ...
      favorite.end_date && favorite.list_type !== "normal_list" && /* @__PURE__ */ jsx(CountdownTimer, { startDate: favorite.start_date, endDate: favorite.end_date }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mkt-body", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "mkt-detail", children: [
        /* @__PURE__ */ jsxs("div", { className: "mkt-crt-bid", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mkt-bid-price", children: /* @__PURE__ */ jsx(
            Price,
            {
              className: "price",
        ...
        /* @__PURE__ */ jsx("div", { className: "mkt-bid-btn", children: /* @__PURE__ */ jsx(Link, { href: `/product/${favorite.slug}`, children: favorite.list_type === "normal_list" ? "Buy Now" : "Place Bid" }) })
      ] })
    ] })
  ] }) });
};
