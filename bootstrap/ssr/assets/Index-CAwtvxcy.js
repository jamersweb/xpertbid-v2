...
function Index({ categories, filters }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Product Categories", children: [
    ...
    /* @__PURE__ */ jsx(Modal, { show: isModalOpen, onClose: closeModal, maxWidth: "2xl", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "flex max-h-[calc(100vh-3rem)] flex-col", children: [
      /* @__PURE__ */ jsxs("div", { className: "sticky top-0 z-10 flex items-center justify-between border-b border-gray-100 bg-white px-8 py-5", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid flex-1 min-h-0 grid-cols-1 md:grid-cols-2 gap-8 overflow-y-auto px-8 py-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            editingCategory?.image && /* @__PURE__ */ jsxs("div", { className: "mb-3 flex items-center gap-3 rounded-2xl border border-gray-100 bg-gray-50/60 p-3", children: [
              /* @__PURE__ */ jsx("div", { className: "h-12 w-12 overflow-hidden rounded-xl border border-gray-200 bg-white flex items-center justify-center", children: /* @__PURE__ */ jsx("img", { src: assetUrl(editingCategory.image), className: "h-full w-full object-cover", alt: "Current category", referrerPolicy: "no-referrer" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-gray-400", children: "Current Image" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-gray-900", children: "Uploaded category image" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center gap-3 p-5 min-h-[110px] border-2 border-dashed border-gray-100 rounded-3xl bg-gray-50/30 hover:bg-gray-50 transition-colors group cursor-pointer relative", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "file",
              ...
              /* @__PURE__ */ jsx("div", { className: "w-11 h-11 bg-white shadow-sm rounded-xl flex items-center justify-center text-gray-400 group-hover:text-black transition-colors", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-cloud-arrow-up text-lg" }) }),
              /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                ...
                data.image && /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs font-bold text-emerald-600 truncate", children: data.image.name })
              ] })
            ] }),
            /* @__PURE__ */ jsx(InputError, { message: errors.image, className: "mt-2" })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(InputLabel, { value: "Upload Category Icon (Optional)", className: "text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2" }),
            editingCategory?.icon && /* @__PURE__ */ jsxs("div", { className: "mb-3 flex items-center gap-3 rounded-2xl border border-gray-100 bg-gray-50/60 p-3", children: [
              /* @__PURE__ */ jsx("div", { className: "h-12 w-12 overflow-hidden rounded-xl border border-gray-200 bg-white p-2 flex items-center justify-center", children: /* @__PURE__ */ jsx("img", { src: assetUrl(editingCategory.icon), className: "h-full w-full object-contain", alt: "Current category icon", referrerPolicy: "no-referrer" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-gray-400", children: "Current Icon" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs font-bold text-gray-900", children: "Uploaded category icon" })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center gap-3 p-5 min-h-[110px] border-2 border-dashed border-gray-100 rounded-3xl bg-gray-50/30 hover:bg-gray-50 transition-colors group cursor-pointer relative", children: [
              /* @__PURE__ */ jsx(
              ...
              /* @__PURE__ */ jsx("div", { className: "w-11 h-11 bg-white shadow-sm rounded-xl flex items-center justify-center text-gray-400 group-hover:text-black transition-colors", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-icons text-lg" }) }),
              /* @__PURE__ */ jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-900", children: "Click to upload icon" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400", children: "PNG, JPG, JPEG or SVG up to 2MB" }),
                data.icon && /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs font-bold text-emerald-600 truncate", children: data.icon.name })
              ] })
            ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "sticky bottom-0 z-10 flex justify-end gap-4 border-t border-gray-100 bg-white px-8 py-5", children: [
