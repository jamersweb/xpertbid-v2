              ...
              /* @__PURE__ */ jsx(
                "img",
                {
                  ...
                  onError: (e) => {
                    ...
                    e.target.src = `https://ui-avatars.com/api/?name=${conv.other_user?.name || "User"}`;
                  }
                }
              ),
              conv.other_user && getLastSeen(conv.other_user.last_active_at) === "Online" && /* @__PURE__ */ jsx("span", { className: "absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-white rounded-full" })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsx("p", { className: `text-xs truncate max-w-[85%] ${selectedConversationId == conv.id ? "text-gray-700" : "text-gray-500"}`, children: conv.last_message ? conv.last_message.type === "image" ? /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1", children: [
                  ...
                  conv.last_message.sender_id === currentUser.id && /* @__PURE__ */ jsx("i", { className: "fa-solid fa-check text-[10px]" }),
                  conv.last_message.body
                ] }) : /* @__PURE__ */ jsx("span", { className: "italic", children: "Start the conversation" }) }),
