...
import { u as useCart, b as buildProductHref, C as CartProvider } from "./productUrl-DG64MGAp.js";
...
function getPropertyRootCategoryId(explicitId) {
...
function isPropertyCategory(category, propertyRootCategoryId = 222) {
...
function getCategoryBrowseUrl(category, options = {}) {
  ...
  if (isPropertyCategory(category, propertyRootCategoryId)) {
    const id = Number(category?.id ?? category?.category_id);
    const isRoot = id === propertyRootCategoryId || String(slug || "").trim().toLowerCase() === PROPERTY_ROOT_SLUG || String(category?.name || "").trim().toLowerCase() === "properties";
    return {
  ...
  return {
    href: route$1("marketplace.type", { slug, typeSlug: "auctions" }),
    external: false
  };
}
function DesktopCategoriesDropdown() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dropdown", ref: dropdownRef, children: [
    ...
    /* @__PURE__ */ jsx("ul", { className: "dropdown-menu", "aria-labelledby": "categoriesDropdown", children: categories.map((cat) => {
      const browse = getCategoryBrowseUrl(cat, { propertyFrontendUrl, propertyRootCategoryId });
      const className = "dropdown-item";
      if (browse.external) {
        return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: browse.href, className, target: "_blank", rel: "noopener noreferrer", children: cat.name }) }, cat.slug);
      }
      return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: browse.href, className, children: cat.name }) }, cat.slug);
    }) })
  ] });
}
function CategoriesDropdown() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dropdown", children: [
    ...
    /* @__PURE__ */ jsx("ul", { className: "dropdown-menu", "aria-labelledby": "categoriesDropdown", children: categories.map((cat) => {
      ...
      const className = "dropdown-item";
      if (browse.external) {
        return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", { href: browse.href, className, target: "_blank", rel: "noopener noreferrer", children: cat.name }) }, cat.id);
      }
      return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: browse.href, className, children: cat.name }) }, cat.id);
    }) })
  ] });
}
  ...
  return /* @__PURE__ */ jsx("div", { className: "loginModal", style: { display: isOpen ? "block" : "none" }, children: /* @__PURE__ */ jsxs("div", { className: "loginModal-content", children: [
    ...
    currentStep === "loginStep" && /* @__PURE__ */ jsxs("div", { id: "loginStep", className: "login-form-step active text-center", children: [
      ...
      /* @__PURE__ */ jsxs("p", { className: "small text-left text-muted mb-0 mt-3", children: [
        ...
        " xpertBid ",
        /* @__PURE__ */ jsx(Link, { href: "/terms", className: "text-decoration-underline text-primary", onClick: onClose, children: t("auth.terms_of_service") }),
        " ",
        t("auth.and"),
        " ",
        /* @__PURE__ */ jsx(Link, { href: "/privacy-policy", className: "text-decoration-underline text-primary", onClick: onClose, children: t("auth.privacy_policy") })
      ] })
    ] }),
    currentStep === "phoneLogin" && /* @__PURE__ */ jsxs("div", { id: "loginStep2", className: "login-form-step", children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "mb-0 fw-bold", children: t("auth.login_with_phone") })
      ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "d-flex justify-content-end mb-3", children: /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsx("p", { className: "mt-2 mb-4 text-muted small", children: t("auth.login_phone_hint") }),
      /* @__PURE__ */ jsx("button", { className: "form-button-1", onClick: handlePhoneLogin, children: t("Login") })
    ] }),
    currentStep === "otpStep" && /* @__PURE__ */ jsxs("div", { id: "otpStep", className: "login-form-step", children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "mb-0 fw-bold", children: t("auth.verify_otp") })
      ] }),
      /* @__PURE__ */ jsxs("p", { className: "mb-4 small text-muted text-center", children: [
        t("auth.enter_sent_otp"),
        " ",
      ...
      errorMessage && /* @__PURE__ */ jsx("div", { className: "alert alert-danger py-2 small mb-3", children: errorMessage }),
      /* @__PURE__ */ jsx("button", { className: "form-button-1", disabled: phoneData.otp.length < 6, onClick: verifyOtp, children: t("auth.verify_and_login") }),
      /* @__PURE__ */ jsx("div", { className: "text-center mt-3", children: /* @__PURE__ */ jsx(
        "button",
        {
          ...
          onClick: sendOtp,
          children: isResendDisabled ? `${t("auth.resend_in")} ${resendTimer}s` : t("auth.resend_code")
        }
      ) })
    ] }),
    currentStep === "loginEmail" && /* @__PURE__ */ jsxs("div", { id: "loginEmail", className: "login-form-step", children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "mb-0 fw-bold", children: t("auth.login_with_email") })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleEmailLogin, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "d-flex justify-content-between align-items-center mb-3", children: [
          /* @__PURE__ */ jsxs("label", { className: "login-remember mb-0 d-inline-flex align-items-center gap-2", htmlFor: "rememberMe", style: { cursor: "pointer" }, children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
            ...
            /* @__PURE__ */ jsx("span", { className: "small text-muted", children: t("auth.remember_me") })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
            {
        ...
        errorMessage && /* @__PURE__ */ jsx("div", { className: "alert alert-danger py-2 small mb-3", children: errorMessage }),
        /* @__PURE__ */ jsx("button", { className: "form-button-1", disabled: emailProcessing, children: emailProcessing ? t("auth.logging_in") : t("auth.continue") })
      ] })
    ] }),
    currentStep === "forgotPassword" && /* @__PURE__ */ jsxs("div", { id: "forgotPasswordStep", className: "login-form-step", style: { backgroundColor: "#ffffff" }, children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "mb-0 fw-bold", children: t("auth.login_or_signup") })
      ] }),
      forgotMessage === "sent" ? /* @__PURE__ */ jsxs("div", { className: "text-center py-4", children: [
        ...
        /* @__PURE__ */ jsx("h2", { className: "fw-bold mb-3", style: { fontSize: "24px" }, children: t("auth.check_email") }),
        /* @__PURE__ */ jsxs("p", { className: "text-muted small mb-4", children: [
          t("auth.reset_link_sent_line_1"),
          /* @__PURE__ */ jsx("br", {}),
          t("auth.reset_link_sent_line_2")
        ] }),
        /* @__PURE__ */ jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "fw-bold mb-3", style: { fontSize: "24px" }, children: t("auth.forgot_your_password") }),
          /* @__PURE__ */ jsx("p", { className: "text-muted small mb-4", children: t("auth.forgot_password_hint") })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mb-3", children: [
          /* @__PURE__ */ jsx(
            "input",
        ...
        /* @__PURE__ */ jsx("button", { className: "form-button-1", onClick: handleForgotPassword, disabled: forgotProcessing, children: forgotProcessing ? t("auth.sending") : t("auth.send_link") })
      ] })
    ] }),
    currentStep === "forgotPasswordPhone" && /* @__PURE__ */ jsxs("div", { id: "forgotPasswordPhoneStep", className: "login-form-step", style: { backgroundColor: "#ffffff" }, children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsx("img", { src: "/assets/images/forgetpassword.svg", className: "mx-auto mt-4 mb-4", alt: "Forgot password illustration" }),
        /* @__PURE__ */ jsx("h2", { className: "fw-bold mb-3", style: { fontSize: "24px" }, children: t("auth.forgot_your_password") }),
        /* @__PURE__ */ jsx("p", { className: "text-muted small mb-4", children: t("auth.forgot_password_phone_hint") })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "mb-3", children: [
        /* @__PURE__ */ jsxs(
          "select",
        ...
        forgotPhoneErrors.phone && /* @__PURE__ */ jsx("div", { className: "alert alert-danger py-2 small mb-3", children: forgotPhoneErrors.phone })
      ] }),
      /* @__PURE__ */ jsx("button", { className: "form-button-1", onClick: handleSendForgotPhoneOtp, disabled: forgotPhoneProcessing, children: forgotPhoneProcessing ? t("auth.sending") : t("auth.send_verification_code") })
    ] }),
    currentStep === "forgotPasswordPhoneOtp" && /* @__PURE__ */ jsxs("div", { id: "forgotPasswordPhoneOtpStep", className: "login-form-step", style: { backgroundColor: "#ffffff" }, children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsx("h2", { className: "fw-bold mb-2 mt-3", style: { fontSize: "22px" }, children: t("auth.verify_otp") }),
        /* @__PURE__ */ jsx("p", { className: "text-muted small mb-4", children: t("auth.enter_whatsapp_otp_desc") })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleVerifyForgotPhoneOtp, children: [
        /* @__PURE__ */ jsx("div", { className: "mb-3 d-flex justify-content-center gap-2", children: [0, 1, 2, 3, 4, 5].map((index) => /* @__PURE__ */ jsx(
          "input",
          {
        ...
        /* @__PURE__ */ jsx("div", { className: "text-center mb-4", children: /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
            className: "btn btn-link text-decoration-none p-0 small text-dark fw-bold",
            ...
            children: isForgotPhoneResendDisabled ? `${t("auth.resend_in")} ${forgotPhoneResendTimer}s` : t("auth.resend_code")
          }
        ) }),
        forgotPhoneErrors.otp && /* @__PURE__ */ jsx("div", { className: "alert alert-danger py-2 small mb-3", children: forgotPhoneErrors.otp }),
        forgotPhoneErrors.general && /* @__PURE__ */ jsx("div", { className: "alert alert-danger py-2 small mb-3", children: forgotPhoneErrors.general }),
        /* @__PURE__ */ jsx("button", { className: "form-button-1", type: "submit", disabled: forgotPhoneProcessing || forgotPhoneData.otp.length < 6, children: forgotPhoneProcessing ? "Verifying..." : t("Verify") || "Verify" })
      ] })
    ] }),
    currentStep === "forgotPasswordPhoneNewPassword" && /* @__PURE__ */ jsxs("div", { id: "forgotPasswordPhoneNewPasswordStep", className: "login-form-step", style: { backgroundColor: "#ffffff" }, children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsx("h2", { className: "fw-bold mb-2 mt-3", style: { fontSize: "22px" }, children: t("auth.set_new_password") || "Set New Password" }),
        /* @__PURE__ */ jsx("p", { className: "text-muted small mb-4", children: t("auth.set_new_password_desc") || "Create a strong new password for your account." })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleResetPhonePassword, children: [
        /* @__PURE__ */ jsxs("div", { className: "mb-3 position-relative", children: [
          /* @__PURE__ */ jsx(
            "input",
            {
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              style: { right: "10px", top: "34px" },
              children: /* @__PURE__ */ jsx("i", { className: `fa-solid ${showForgotPhonePassword ? "fa-eye-slash" : "fa-eye"}` })
            }
          )
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mb-3 position-relative", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              style: { right: "10px", top: "34px" },
              children: /* @__PURE__ */ jsx("i", { className: `fa-solid ${showForgotPhoneConfirmPassword ? "fa-eye-slash" : "fa-eye"}` })
            }
          )
        ] }),
        forgotPhoneErrors.password && /* @__PURE__ */ jsx("div", { className: "alert alert-danger py-2 small mb-3", children: forgotPhoneErrors.password }),
        forgotPhoneErrors.password_confirmation && /* @__PURE__ */ jsx("div", { className: "alert alert-danger py-2 small mb-3", children: forgotPhoneErrors.password_confirmation }),
        forgotPhoneErrors.general && /* @__PURE__ */ jsx("div", { className: "alert alert-danger py-2 small mb-3", children: forgotPhoneErrors.general }),
        /* @__PURE__ */ jsx("button", { className: "form-button-1", type: "submit", disabled: forgotPhoneProcessing, children: forgotPhoneProcessing ? t("auth.sending") : t("auth.reset_password") })
      ] })
    ] }),
    currentStep === "forgotPasswordPhoneSuccess" && /* @__PURE__ */ jsx("div", { id: "forgotPasswordPhoneSuccessStep", className: "login-form-step", style: { backgroundColor: "#ffffff" }, children: /* @__PURE__ */ jsxs("div", { className: "text-center py-4", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsx("img", { src: "/assets/images/send_email.png", alt: "Success", width: 120, height: 120, className: "mx-auto" }) }),
      /* @__PURE__ */ jsx("h2", { className: "fw-bold mb-3", style: { fontSize: "24px" }, children: t("auth.password_reset_success") }),
      /* @__PURE__ */ jsx("p", { className: "text-muted small mb-4", children: t("auth.password_reset_success_desc") }),
      /* @__PURE__ */ jsx(
        "button",
        {
          className: "form-button-1",
...
const RegisterModal = ({ isOpen, onClose, onSwitchToLogin }) => {
  ...
  const updateOtpDigit = (index, value) => {
    ...
    if (digits.length > 1) {
      const nextOtp2 = digits.slice(0, 6);
      setData("otp", nextOtp2);
      otpInputRefs.current[Math.min(nextOtp2.length, 5)]?.focus();
      return;
    }
  ...
  if (!isOpen) return null;
  return /* @__PURE__ */ jsx("div", { id: "SignupModal", className: "signupModal video-modal", style: { display: isOpen ? "block" : "none", position: "fixed", top: 0, left: 0, width: "100%", height: "100%", backgroundColor: "rgba(0,0,0,0.5)", zIndex: 1060, overflowY: "auto" }, children: /* @__PURE__ */ jsxs("div", { className: `signupmodal-content ${activeStep === "otpVerification" ? "signupmodal-content--otp" : ""}`, style: { position: "relative", margin: "50px auto", backgroundColor: "#fff", padding: "20px", borderRadius: "10px", maxWidth: "600px" }, children: [
    ...
    activeStep === "step1" && /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("h2", { className: "mb-4 fw-bold text-center", children: t("Sign Up") }),
    ...
    activeStep === "emailSignup" && /* @__PURE__ */ jsxs("div", { id: "stepEmail", children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "mb-0 fw-bold", children: t("auth.signup_with_email") })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: handleEmailRegister, children: [
        ...
        /* @__PURE__ */ jsx("button", { className: "form-button-1", disabled: processing, children: processing ? t("auth.creating_account") : t("auth.continue") })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "text-center mt-3", children: [
        ...
        /* @__PURE__ */ jsx("button", { className: "btn btn-link text-decoration-underline p-0 small text-dark fw-bold", onClick: onSwitchToLogin, children: t("Login") })
      ] })
    ] }),
    activeStep === "phoneSignup" && /* @__PURE__ */ jsxs("div", { id: "phoneSignup", children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back", children: [
        ...
        /* @__PURE__ */ jsx("h3", { className: "mb-0 fw-bold", children: t("auth.signup_with_phone") })
      ] }),
    ...
    activeStep === "otpVerification" && /* @__PURE__ */ jsxs("div", { id: "emailOtp-container", className: "signup-otp-panel", children: [
      /* @__PURE__ */ jsxs("div", { className: "step-heading-and-back signup-otp-header", children: [
        /* @__PURE__ */ jsx("button", { className: "backbuttonSignup signup-otp-back", onClick: () => handleStepChange("phoneSignup"), "aria-label": "Back", children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-chevron-left" }) }),
        /* @__PURE__ */ jsx("h3", { className: "mb-0 fw-bold", children: "Verify OTP" })
      ] }),
      /* @__PURE__ */ jsxs("p", { className: "signup-otp-copy", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "signup-otp-input-wrap", onPaste: (e) => {
        e.preventDefault();
      ...
      errorMessage && /* @__PURE__ */ jsx("div", { className: "alert-message", children: errorMessage }),
      /* @__PURE__ */ jsx("button", { className: "form-button-1 signup-otp-submit", disabled: loading || !formData.otp || formData.otp.length < 6, onClick: handleVerifyPhoneOtp, children: loading ? "Verifying..." : "Verify & Sign Up" }),
      /* @__PURE__ */ jsx("div", { className: "signup-otp-resend", children: /* @__PURE__ */ jsx(
        "button",
        {
...
function Header() {
  ...
  const renderProfileMenuContent = (label, icon) => isRtl ? /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("header", { className: "bg-white ", style: { zIndex: 1050 }, children: /* @__PURE__ */ jsx("nav", { className: "navbar navbar-expand-lg navbar-light bg-white py-2", id: "mainNavbar", children: /* @__PURE__ */ jsxs("div", { className: "container-fluid px-lg-5 my-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { ref: mobileMenuRef, className: `navbar-collapse xpert-mobile-menu ${isMenuOpen ? "show" : ""}`, id: "navbarSupportedContent", children: [
        /* @__PURE__ */ jsxs("ul", { className: "navbar-nav me-auto mb-2 mb-lg-0 align-items-lg-center", children: [
          /* @__PURE__ */ jsx("li", { className: "nav-item d-none d-lg-block me-3", children: /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "ms-2 text-muted small", children: t("Search auctions") })
              ]
            }
          ) }),
          ...
          /* @__PURE__ */ jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsx(Link, { href: "/live-auctions", className: "nav-link", onClick: closeMobileMenu, children: t("Live Auctions") }) }),
          /* @__PURE__ */ jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsx(Link, { href: route$1("about"), className: "nav-link", onClick: closeMobileMenu, children: t("About") }) }),
          /* @__PURE__ */ jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsx(Link, { href: route$1("auctions.one_rupee"), className: "nav-link", onClick: closeMobileMenu, children: t("1 Rupee Auctions") }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "d-flex align-items-center mt-3 mt-lg-0 header-account-cluster", children: [
          ...
          !user ? /* @__PURE__ */ jsxs("div", { className: "registration-btns d-flex align-items-center", children: [
            /* @__PURE__ */ jsx("button", { className: "login me-4", onClick: openLogin, children: t("Login") }),
            /* @__PURE__ */ jsx("button", { className: "signup me-2", onClick: openRegister, children: t("Sign Up") }),
            /* @__PURE__ */ jsx(
              "button",
              {
          ...
          ] }) : /* @__PURE__ */ jsxs("div", { className: "d-flex align-items-center header-user-actions", children: [
            /* @__PURE__ */ jsxs("div", { className: "user-profile-setting-container d-none d-lg-block", ref: userProfileRefDesktop, children: [
              ...
              isUserSettingsOpenDesktop && /* @__PURE__ */ jsx("div", { id: "userProfileSettingPopup", className: "user-profile-setting-popup show", style: { position: "absolute", right: isRtl ? "auto" : 0, left: isRtl ? 0 : "auto", top: "100%" }, children: /* @__PURE__ */ jsx("div", { className: "user-profile-setting-content", style: { padding: isRtl ? "18px 12px 18px 18px" : "18px 18px 18px 12px", textAlign: isRtl ? "right" : "left" }, children: /* @__PURE__ */ jsxs("ul", { className: "user-setting-menu", style: { paddingLeft: 0, listStyle: "none", marginBottom: 0, width: "100%" }, children: [
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsx(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: profileMenuItemStyle, href: route$1("profile.edit"), children: renderProfileMenuContent(t("Account Settings"), /* @__PURE__ */ jsx("img", { src: "/assets/images/profile-setting.svg", alt: "Settings", width: 20, height: 20 })) }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsx(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: profileMenuItemStyle, href: route$1("chat.index"), children: renderProfileMenuContent(t("Messages"), /* @__PURE__ */ jsx("i", { className: "fa-solid fa-comment-dots text-center", style: { width: "20px", fontSize: "18px" } })) }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsx(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: profileMenuItemStyle, href: route$1("favorites.index"), children: renderProfileMenuContent(t("My Favorites"), /* @__PURE__ */ jsx("img", { src: "/assets/images/setting-heart.svg", alt: "Favorites", width: 20, height: 20 })) }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsx(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: profileMenuItemStyle, href: route$1("auctions.mylistings"), children: renderProfileMenuContent(t("My Listings"), /* @__PURE__ */ jsx("img", { src: "/assets/images/mainListing.svg", alt: "Listings", width: 20, height: 20 })) }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsx(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: profileMenuItemStyle, href: route$1("bids.index"), children: renderProfileMenuContent(t("My Bids"), /* @__PURE__ */ jsx("img", { src: "/assets/images/myBids.svg", alt: "Bids", width: 20, height: 20 })) }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsx(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: profileMenuItemStyle, href: route$1("orders.index"), children: renderProfileMenuContent(t("My Orders"), /* @__PURE__ */ jsx("i", { className: "fa-solid fa-box-open text-center", style: { width: "20px", fontSize: "18px" } })) }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsx(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: profileMenuItemStyle, href: route$1("payment_requests.index"), children: renderProfileMenuContent(t("Payment Request"), /* @__PURE__ */ jsx("i", { className: "fa-solid fa-money-check text-center", style: { width: "20px", fontSize: "18px" } })) }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsx(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: profileMenuItemStyle, href: route$1("verification.identity"), children: renderProfileMenuContent(t("Verification"), /* @__PURE__ */ jsx("i", { className: "fa-solid fa-id-card text-center", style: { width: "20px", fontSize: "18px" } })) }) }),
                /* @__PURE__ */ jsx("li", { style: { padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px", marginTop: "14px" }, children: /* @__PURE__ */ jsx("button", { className: "transparent-button d-flex align-items-center gap-2 border-0 bg-transparent p-0", style: profileMenuButtonStyle, onClick: handleLogout, children: renderProfileMenuContent(t("Log Out"), /* @__PURE__ */ jsx("img", { src: "/assets/images/logout.svg", alt: "Logout" })) }) })
              ] }) }) })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
  ...
  return /* @__PURE__ */ jsx("footer", { className: "footer", children: /* @__PURE__ */ jsxs("div", { className: "container-fluid", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "row ", children: [
      /* @__PURE__ */ jsxs("div", { className: "col-xl-4  col-sm-6 footer-child1", children: [
        ...
        /* @__PURE__ */ jsx("p", { children: t("First ever UAE based auction platform, providing you a one stop shop, auction marketplace/platform. From real estate, vehicles, bulk goods and much more, XpertBid powers auctions that deliver value, security, and results one auction at a time.") }),
        "              ",
      ...
      /* @__PURE__ */ jsx("div", { className: "col-xl-4   col-sm-6 footer-child3", children: /* @__PURE__ */ jsxs("div", { className: "footer-menu ps-0 ps-sm-4", children: [
        /* @__PURE__ */ jsxs("p", { className: "foot-menu-heading my-4", children: [
          " ",
          t("Get To Know Us")
        ] }),
        /* @__PURE__ */ jsxs("ul", { children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("faq"), children: t("FAQ") }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("blogs.index"), children: t("Blogs") }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("about"), children: t("About Us") }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("about.partners"), children: t("About Our Partners") }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("contact"), children: t("Contact Us") }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "col-xl-4   col-sm-6 footer-child3 mt-0 mt-sm-3", children: /* @__PURE__ */ jsx("div", { className: "footer-menu ps-0 ps-sm-4 mt-0 mt-sm-5", children: /* @__PURE__ */ jsxs("ul", { children: [
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("refund.policy"), children: t("Refund Policy") }) }),
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("shipping.policy"), children: t("Shipping Policy") }) }),
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("seller.policy"), children: t("Seller Policy") }) }),
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("privacy.policy"), children: t("Privacy Policy") }) }),
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route$1("terms"), children: t("Terms & Conditions") }) })
      ] }) }) }),
      /* @__PURE__ */ jsx("div", { className: "col-xl-3 col-sm-6 footer-child3 mt-0 mt-sm-5", children: /* @__PURE__ */ jsxs("div", { className: "footer-menu ps-0 ps-sm-4 mt-0 mt-lg-3", children: [
        loading && /* @__PURE__ */ jsx("div", { className: "d-flex justify-content-center", children: /* @__PURE__ */ jsx(Oval, { height: 30, width: 30, ariaLabel: t("Loading categories") }) }),
      ...
      /* @__PURE__ */ jsxs(
        Link,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "mobile-bottom-nav__label", children: t("Home") })
          ]
        }
      ),
      isAuthenticated ? /* @__PURE__ */ jsxs(
        Link,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "mobile-bottom-nav__label", children: t("Chat") })
          ]
        }
      ) : /* @__PURE__ */ jsxs(
        "button",
      ...
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "mobile-bottom-nav__label", children: t("Sell") })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
        Link,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "mobile-bottom-nav__label", style: { fontSize: "10px", lineHeight: "1.1", textAlign: "center" }, children: t("1 Rupee") })
          ]
        }
      ),
        ...
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "mobile-bottom-nav__label", children: t("Profile") })
            ]
          }
        ),
  ...
  return /* @__PURE__ */ jsx(CartProvider, { children: /* @__PURE__ */ jsxs(AuthModalProvider, { children: [
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-100", children: [
      ...
      toast.show && /* @__PURE__ */ jsx("div", { className: "toast-container", children: /* @__PURE__ */ jsxs("div", { className: `premium-toast ${isHiding ? "hiding" : ""}`, style: { borderLeftColor: toast.type === "error" ? "#FF4D4D" : "#43ACE9" }, children: [
        ...
        ] }) : toast.type === "info" ? /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "3", strokeLinecap: "round", strokeLinejoin: "round", children: [
          /* @__PURE__ */ jsx("line", { x1: "12", y1: "10", x2: "12", y2: "17" }),
          /* @__PURE__ */ jsx("line", { x1: "12", y1: "7", x2: "12.01", y2: "7" })
        ...
        /* @__PURE__ */ jsxs("div", { className: "premium-toast-content", children: [
          /* @__PURE__ */ jsx("div", { style: { fontWeight: "600", fontSize: "15px", color: "#fff" }, children: toast.type === "error" ? t("Error") : toast.type === "info" ? t("Notice") : t("Success") }),
          /* @__PURE__ */ jsx("div", { style: { fontSize: "13px", opacity: 0.8, color: "#fff" }, children: toast.message })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxs("section", { className: "xp-brand-top-banner", "aria-label": "XpertBid brand banner", children: [
        /* @__PURE__ */ jsxs("div", { className: "xp-brand-links", children: [
          /* @__PURE__ */ jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsx("img", { className: "xp-brand-logo xp-brand-logo-prop", src: "/assets/images/xp-prop-logo-clean.png", alt: "XpertBid Property" })
            }
          ),
          /* @__PURE__ */ jsx(Link, { className: "xp-brand-link", href: "/marketplace/vehicles?type=auction", "aria-label": "View vehicle marketplace", children: /* @__PURE__ */ jsx("img", { className: "xp-brand-logo xp-brand-logo-vehicle", src: "/assets/images/xp-vehicle-logo-clean.png", alt: "XpertBid Vehicle" }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "xp-brand-controls d-none d-lg-flex", children: [
          /* @__PURE__ */ jsx(
            "select",
            {
      ...
      shouldShowVerifyButton && /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { children: t("Verify Account") })
          ]
        }
      ),
      /* @__PURE__ */ jsx(Footer, {}),
...
export {
  AppLayout as A,
  AuthModalProvider as a,
  getCategoryBrowseUrl as g
};
