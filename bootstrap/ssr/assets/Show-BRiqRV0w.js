...
function Show({ auction, bids, related, highestBid, winnerDetails, isFavorite, dynamicFields = [] }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: auction.title, children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "product-image-and-brief", children: /* @__PURE__ */ jsx("div", { className: "container-fluid", children: /* @__PURE__ */ jsxs("div", { className: `products-brief-parent${auction.featured_name === "home_featured" ? " listing_promoted" : ""}`, children: [
      ...
      auction.youtube_video_id ? /* @__PURE__ */ jsx("div", { className: "row mt-4", children: /* @__PURE__ */ jsxs("div", { className: "col-12", children: [
        /* @__PURE__ */ jsx("h2", { className: "h5 fw-bold mb-3", children: "Live stream" }),
        /* @__PURE__ */ jsx(YoutubeLiveEmbed, { videoId: auction.youtube_video_id, title: auction.title }),
        /* @__PURE__ */ jsx("p", { className: "small text-muted mt-2 mb-0", children: "Stream is hosted on YouTube. Bid timing and results follow this listing on XpertBid, not the video clock." })
      ] }) }) : null
    ] }) }) }),
