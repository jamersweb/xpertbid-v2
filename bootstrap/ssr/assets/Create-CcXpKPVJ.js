    ...
    /* @__PURE__ */ jsx("form", { className: "verification-form", onSubmit: handleNext, noValidate: true, children: /* @__PURE__ */ jsxs("div", { className: "sell-form-inner", children: [
      ...
      isProperty && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "identity-upload-section mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("ul", { className: "liss mb-3 text-muted small", children: [
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "upload-dropzone-content", children: [
                  /* @__PURE__ */ jsx("i", { className: "fa-solid fa-cloud-arrow-up fa-2x mb-3 text-muted" }),
          ...
          formData.property_documents && formData.property_documents.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
            /* @__PURE__ */ jsx("p", { className: "small fw-bold mb-2", children: "Selected Files:" }),
            /* @__PURE__ */ jsx("ul", { className: "list-unstyled", children: Array.from(formData.property_documents).map((file, idx) => /* @__PURE__ */ jsx("li", { className: "small text-muted", children: file.name }, idx)) })
          ] })
        ] })
      ] }),
      isVehicle && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "identity-upload-section mb-4", children: [
          ...
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "upload-dropzone-content", children: [
                  /* @__PURE__ */ jsx("i", { className: "fa-solid fa-cloud-arrow-up fa-2x mb-3 text-muted" }),
                  /* @__PURE__ */ jsx("p", { className: "mb-1 fw-bold", children: "Drag & drop or click to upload documents" }),
          ...
          formData.vehicle_documents && formData.vehicle_documents.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mt-3", children: [
            /* @__PURE__ */ jsx("p", { className: "small fw-bold mb-2", children: "Selected Files:" }),
            /* @__PURE__ */ jsx("ul", { className: "list-unstyled", children: Array.from(formData.vehicle_documents).map((file, idx) => /* @__PURE__ */ jsx("li", { className: "small text-muted", children: file.name }, idx)) })
          ] })
        ] })
      ] }),
...
function MediaUpload({ files, setFiles, existingFiles = [], setExistingFiles, summaryData, onContinue, onBack, onEditListType, onEditCategory, onEditDetails, onEditVerification, onSaveDraft, isSavingDraft }) {
...
function Create({ categories, listing = null }) {
