...
import "axios";
function Index({ settings, currencyLastSyncedAt }) {
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 p-6", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-sm font-bold text-gray-800 mb-3 uppercase tracking-wider", children: "Currencies" }),
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mb-2", children: "Automatic exchange rate sync runs every 6 hours." }),
          /* @__PURE__ */ jsxs("div", { className: "rounded-xl bg-sky-50 border border-sky-100 px-4 py-3", children: [
            /* @__PURE__ */ jsx("p", { className: "text-[11px] font-bold uppercase tracking-wider text-sky-600 mb-1", children: "Last Sync" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-gray-800", children: formattedCurrencySyncTime })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 p-6", children: [
