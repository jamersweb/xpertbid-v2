...
import { u as useCart } from "./CartContext-eSDe5PYw.js";
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "row", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "col-lg-5 edit-promote d-flex align-items-center", children: [
          ...
          isActive && !isDraft && listing.slug && /* @__PURE__ */ jsx(Link, { href: `/product/${listing.slug}`, className: "ms-2", children: /* @__PURE__ */ jsx("button", { className: "button-style-1 editListing", children: "View" }) }),
