...
function Index({ orders }) {
  return /* @__PURE__ */ jsxs(AppLayout, { title: "My Orders", children: [
    /* @__PURE__ */ jsxs("div", { className: "container py-5", children: [
      /* @__PURE__ */ jsx("div", { className: "d-flex justify-content-between align-items-center mb-4", children: /* @__PURE__ */ jsx("h3", { style: { fontWeight: "700", color: "#1a1a1a", margin: 0 }, children: "My Orders" }) }),
      orders.data.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-5 bg-white rounded-3 border", children: [
        ...
        /* @__PURE__ */ jsx("h4", { style: { color: "#666" }, children: "No orders found" }),
        /* @__PURE__ */ jsx("p", { style: { color: "#999", marginBottom: "30px" }, children: "You haven't placed any orders yet." }),
        /* @__PURE__ */ jsx(
          Link,
          {
            href: "/marketplace",
              ...
              /* @__PURE__ */ jsx("div", { className: "order-items", children: order.items.map((item, idx) => {
                ...
                return /* @__PURE__ */ jsxs("div", { className: "d-flex align-items-center mb-3 p-2 rounded-3", style: { backgroundColor: "#fafafa", border: "1px solid #f0f0f0" }, children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex-grow-1", children: [
                    /* @__PURE__ */ jsx("h6", { className: "mb-1 fw-bold", style: { fontSize: "15px", color: "#333" }, children: item.listing?.title || "Product" }),
