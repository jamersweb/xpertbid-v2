...
function Index({ requests }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Payment Requests", children: [
    ...
    /* @__PURE__ */ jsx("div", { style: { padding: "50px 0", minHeight: "70vh", backgroundColor: "#fff" }, children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
      /* @__PURE__ */ jsx("h1", { style: { fontSize: "42px", fontWeight: "800", color: "#23262F", margin: "0 0 32px 0" }, children: "My Payment Requests" }),
      /* @__PURE__ */ jsxs("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { style: { borderBottom: "2px solid #E6E8EC" }, children: [
          /* @__PURE__ */ jsx("th", { style: { padding: "14px 0", fontWeight: "700", color: "#23262F", fontSize: "15px", textAlign: "left" }, children: "Amount" }),
          /* @__PURE__ */ jsx("th", { style: { padding: "14px 0", fontWeight: "700", color: "#23262F", fontSize: "15px", textAlign: "left" }, children: "Payment Method" }),
          /* @__PURE__ */ jsx("th", { style: { padding: "14px 0", fontWeight: "700", color: "#23262F", fontSize: "15px", textAlign: "left" }, children: "Status" })
        ] }) }),
        /* @__PURE__ */ jsx("tbody", { children: requests.data.length === 0 ? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: "3", style: { padding: "20px 0", color: "#353945", fontSize: "15px", fontWeight: "500" }, children: "No payment requests found." }) }) : requests.data.map((request) => /* @__PURE__ */ jsxs("tr", { style: { borderBottom: "1px solid #E6E8EC" }, children: [
          ...
          /* @__PURE__ */ jsx("td", { style: { padding: "16px 0", color: "#353945", fontSize: "15px" }, children: request.payment_method?.paymentMethod || "Direct Transfer" }),
