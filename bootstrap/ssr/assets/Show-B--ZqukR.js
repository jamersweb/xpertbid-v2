...
import { A as AuctionCard } from "./AuctionCard-DYpcFX8c.js";
import "ziggy-js";
import "react-loader-spinner";
import "sweetalert2";
import "./OwnerInfoRow-DymfsfZX.js";
...
function ProductHeader({ views, productId, slug, link }) {
  ...
  return /* @__PURE__ */ jsx("section", { className: "prodcut-detail-links", style: { paddingTop: "100px" }, children: /* @__PURE__ */ jsx("div", { className: "container-fluid", children: /* @__PURE__ */ jsxs("div", { className: "row", children: [
...
function ProductImages({ albumImages, videos = null, status, mainImage }) {
  let parsedAlbum = [];
...
function BidSection({ product, highestBidProp, onBidPlaced, winnerDetails, isFavoriteProp }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "product-details-brief-parent", style: { padding: "0 10px" }, children: [
    ...
    product.list_type === "auction" ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs("div", { className: "bid-rank-and-time bg-light p-3 rounded-3 mb-3 d-flex justify-content-between align-items-center", children: [
        /* @__PURE__ */ jsxs("div", { className: "bid-price-and-rank d-flex flex-column", children: [
          /* @__PURE__ */ jsx("span", { className: "rank text-muted small fw-semibold", children: "Highest Bid" }),
          /* @__PURE__ */ jsx("div", { className: "price fw-bold text-dark", style: { fontSize: "24px" }, children: /* @__PURE__ */ jsx(Price, { amountAED: highestBid }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bid-time-and-date text-end d-flex flex-column", children: [
          /* @__PURE__ */ jsx("span", { className: "endin text-muted small fw-semibold", children: "End in" }),
          /* @__PURE__ */ jsx("p", { className: "date mb-0 text-dark fw-semibold", style: { fontSize: "14px" }, children: formatDate(product.end_date) })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "bid-rank-and-time bg-light p-3 rounded-3 mb-3 d-flex justify-content-between align-items-center", children: /* @__PURE__ */ jsxs("div", { className: "bid-price-and-rank d-flex flex-column", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "price fw-bold d-flex align-items-center gap-2", children: [
          product.discount_value > 0 && /* @__PURE__ */ jsx("span", { className: "text-decoration-line-through text-muted", style: { fontSize: "16px" }, children: /* @__PURE__ */ jsx(Price, { amountAED: product.minimum_bid }) }),
          /* @__PURE__ */ jsx("span", { className: "text-dark", style: { fontSize: "28px" }, children: /* @__PURE__ */ jsx(Price, { amountAED: product.buy_now_price || product.minimum_bid }) }),
          product.discount_value > 0 && /* @__PURE__ */ jsx("span", { className: "badge bg-danger", children: product.discount_type === "percent" ? `${product.discount_value}% OFF` : "SALE" })
        ] })
      ] }) }),
