    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-gray-50 text-gray-500 text-xs font-bold uppercase tracking-wider", children: [
          /* @__PURE__ */ jsx("th", { className: "px-4 py-4", children: "Stream" }),
          /* @__PURE__ */ jsx("th", { className: "px-4 py-4", children: "Selected Auctions" }),
          /* @__PURE__ */ jsx("th", { className: "px-4 py-4", children: "Schedule" }),
          /* @__PURE__ */ jsx("th", { className: "px-4 py-4", children: "Status" }),
          /* @__PURE__ */ jsx("th", { className: "px-4 py-4 text-right", children: "Actions" })
        ] }) }),
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-100", children: sessions.data.map((session) => {
          ...
          return /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/60 transition-colors", children: [
            ...
            /* @__PURE__ */ jsxs("td", { className: "px-4 py-4 whitespace-nowrap", children: [
              /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-900 mb-0", children: session.scheduled_at ? new Date(session.scheduled_at).toLocaleString() : "N/A" }),
              /* @__PURE__ */ jsxs("p", { className: "text-[11px] text-gray-500 mb-0", children: [
                "Created: ",
                new Date(session.created_at).toLocaleString()
              ] })
            ] }),
            /* @__PURE__ */ jsx("td", { className: "px-4 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("span", { className: `px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${statusClasses[session.status] || "bg-gray-100 text-gray-700"}`, children: statusLabel(session.status) }) }),
            /* @__PURE__ */ jsx("td", { className: "px-4 py-4 text-right", children: /* @__PURE__ */ jsx("div", { className: "flex items-center justify-end gap-2", children: /* @__PURE__ */ jsx(
              "button",
              {
                type: "button",
