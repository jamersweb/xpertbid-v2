...
function CategorySelection({ categories: initialCategories, onSelect, onBack, onSaveDraft, isSavingDraft, progressPercent = 0 }) {
  ...
  const loadSubCategories = async (categoryId) => {
    ...
    try {
      ...
      console.error("Error loading subcategories", error2);
    }
  };
  const loadChildCategories = async (subCategoryId) => {
    ...
    try {
      ...
      console.error("Error loading child categories", error2);
    }
  };
  ...
  return /* @__PURE__ */ jsxs("section", { className: "category-stage category-stage--active", children: [
    ...
    error && /* @__PURE__ */ jsx("div", { className: "alert alert-danger mx-3 mb-3", role: "alert", children: error }),
...
function DetailsForm({
  ...
  const validate = () => {
    ...
    (dynamicFields || []).forEach((field) => {
      ...
      if (field.is_required && (value === null || value === void 0 || String(value).trim() === "" || value === false)) {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "details-stage py-5", children: [
    ...
    /* @__PURE__ */ jsx("form", { className: "details-form", onSubmit: handleNext, noValidate: true, children: /* @__PURE__ */ jsxs("div", { className: "sell-form-inner", children: [
      Object.keys(errors).length > 0 && /* @__PURE__ */ jsx("div", { className: "alert alert-danger mb-4", role: "alert", children: "Please fix the highlighted fields before continuing." }),
      /* @__PURE__ */ jsx(
        SummaryCard,
        {
          type: "List Type",
      ...
      /* @__PURE__ */ jsxs("div", { className: "details-stage-actions d-flex justify-content-between align-items-center mt-5", children: [
        ...
        /* @__PURE__ */ jsx("button", { type: "submit", className: "btn btn-black px-5", children: "Confirm" })
      ] })
    ] }) })
  ] });
}
const API_KEY = "AIzaSyBp2Z0Y26ochLtLKHGNk6aFl7-X5U4kdnM";
function GoogleLocationPicker({
  ...
  useEffect(() => {
    ...
    try {
      ...
      const defaultLat = parseFloat(latitudeValue) || 24.8607;
      ...
      const marker = new google.maps.Marker({
        ...
        map,
        draggable: true,
        animation: google.maps.Animation ? google.maps.Animation.DROP : void 0,
  ...
  const updateParent = ({ address, lat, lng }) => {
    const finalAddress = address !== void 0 ? address : currentAddress;
    const finalLat = lat !== void 0 ? lat : latitudeValue;
    const finalLng = lng !== void 0 ? lng : longitudeValue;
  ...
  const handleCurrentLocationClick = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      { timeout: 15e3, enableHighAccuracy: false, maximumAge: 6e4 }
    );
  };
  if (loadError || !API_KEY) {
    return /* @__PURE__ */ jsxs("div", { className: "form-group mb-4", children: [
      /* @__PURE__ */ jsxs("label", { className: "form-label fw-bold", children: [
        "Property Address ",
        /* @__PURE__ */ jsx("span", { className: "text-danger", children: "*" })
      ] }),
      ...
      error && /* @__PURE__ */ jsx("p", { className: "text-danger small mt-1", children: error })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "form-group mb-4", children: [
    /* @__PURE__ */ jsxs("div", { className: "d-flex justify-content-between align-items-center mb-2", children: [
      /* @__PURE__ */ jsxs("label", { className: "form-label fw-bold m-0", children: [
      ...
      /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("i", { className: `fa-solid ${isLocating ? "fa-spinner fa-spin" : "fa-location-crosshairs"}` }),
            isLocating ? "Locating..." : "Use Current Location"
          ]
        }
      )
    ] }),
    geoError && /* @__PURE__ */ jsxs("p", { className: "text-warning small mb-2", children: [
      /* @__PURE__ */ jsx("i", { className: "fa-solid fa-triangle-exclamation me-1" }),
      geoError
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "position-relative mb-3", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          ref: inputRef,
    ...
    error && /* @__PURE__ */ jsx("p", { className: "text-danger small mt-1 mb-2", children: error }),
    /* @__PURE__ */ jsx(
      "div",
      {
        ref: mapContainerRef,
        ...
        children: !isLoaded && /* @__PURE__ */ jsxs("div", { className: "d-flex align-items-center justify-content-center h-100 text-muted", children: [
          /* @__PURE__ */ jsx("div", { className: "spinner-border spinner-border-sm me-2", role: "status" }),
          "Loading Map..."
        ] })
      }
    ),
    /* @__PURE__ */ jsxs("span", { className: "form-text text-muted small mt-1 d-block", children: [
...
function VerificationStep({ categoryId, categoryObj, formData, setFormData, summaryData, onContinue, onBack, onEditListType, onEditCategory, onEditDetails, onSaveDraft, isSavingDraft, progressPercent = 0 }) {
  const catIdStr = String(categoryId || "");
  const nameStr = String(categoryObj?.name || "").toLowerCase();
  const slugStr = String(categoryObj?.slug || "").toLowerCase();
  const isProperty = catIdStr === "222" || slugStr.includes("property") || slugStr.includes("real-estate") || nameStr.includes("property") || nameStr.includes("real estate");
  const isVehicle = catIdStr === "311" || slugStr.includes("vehicle") || slugStr.includes("car") || nameStr.includes("vehicle") || nameStr.includes("car");
  ...
  const validate = () => {
    ...
    if (isVehicle) {
      ...
      } else if (!/^\d{4}$/.test(String(year)) || Number(year) < 1900 || Number(year) > (/* @__PURE__ */ new Date()).getFullYear() + 1) {
      ...
      /* @__PURE__ */ jsxs("div", { className: "media-stage-actions d-flex justify-content-between align-items-center mt-5", children: [
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: canPublish ? "Confirm" : "Verification Required"
          }
        )
      ] })
    ] }) })
...
function Create({ categories, countries = [], profileLocation = null, listing = null, vehicleVerification = null, propertyVerification = null }) {
  ...
  const isPropertyCategory = (catId, catObj) => {
    ...
    return idStr === "222" || slugStr.includes("property") || slugStr.includes("real-estate") || nameStr.includes("property") || nameStr.includes("real estate");
  };
  const isVehicleCategory = (catId, catObj) => {
    const idStr = String(catId || "");
    const nameStr = String(catObj?.name || "").toLowerCase();
    const slugStr = String(catObj?.slug || "").toLowerCase();
    return idStr === "311" || slugStr.includes("vehicle") || slugStr.includes("car") || nameStr.includes("vehicle") || nameStr.includes("car");
  };
  ...
  const submitAuction = async (status) => {
    ...
    const variationPrices = (Array.isArray(formData.variations) ? formData.variations : []).map((variation) => Number(variation?.price)).filter((value) => Number.isFinite(value) && value > 0);
