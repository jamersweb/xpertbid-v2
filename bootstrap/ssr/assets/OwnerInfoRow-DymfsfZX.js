...
const CountdownTimer = ({ endDate }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "counter", children: isActive ? /* @__PURE__ */ jsxs("div", { className: "counter-grid", children: [
...
const formatName = (name = "") => {
  const formatted = name.split(" ").filter(Boolean).slice(0, 5).map((word) => word.charAt(0).toUpperCase() + word.slice(1).toLowerCase()).join(" ") || "User";
