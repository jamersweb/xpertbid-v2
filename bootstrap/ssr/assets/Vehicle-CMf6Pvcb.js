...
function Vehicle({ verifications }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Vehicle Verifications", children: [
    /* @__PURE__ */ jsx(Head, { title: "Vehicle Verifications" }),
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left border-collapse", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "bg-gray-50 text-gray-500 text-xs font-bold uppercase tracking-wider", children: [
          /* @__PURE__ */ jsx("th", { className: "px-6 py-4", children: "Vehicle Details" }),
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-100", children: verifications.data.map((verification) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50 transition-colors", children: [
          /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-gray-800", children: verification.vehicle_make_model }),
            /* @__PURE__ */ jsxs("p", { className: "text-[11px] text-gray-500", children: [
              "VIN: ",
              verification.chassis_vin,
              " (",
              verification.year_of_manufacture,
              ")"
            ] }),
            /* @__PURE__ */ jsxs("p", { className: "text-[10px] text-amber-600 font-bold", children: [
              "Auction: ",
              verification.auction?.title
            ] })
          ] }),
          /* @__PURE__ */ jsxs("td", { className: "px-6 py-4", children: [
          ...
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("div", { className: "flex gap-1 flex-wrap max-w-[150px]", children: (verification.vehicle_documents || []).map((doc, idx) => /* @__PURE__ */ jsxs("a", { href: "/" + doc, target: "_blank", className: "text-[10px] bg-gray-100 text-gray-900 hover:bg-gray-200 px-2 py-1 rounded", children: [
            "Doc ",
            idx + 1
          ] }, idx)) }) }),
    ...
    /* @__PURE__ */ jsx(Modal, { show: isModalOpen, onClose: () => setIsModalOpen(false), maxWidth: "md", children: /* @__PURE__ */ jsxs("div", { className: "p-6", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-bold text-gray-800 mb-4", children: "Decline Vehicle Verification" }),
