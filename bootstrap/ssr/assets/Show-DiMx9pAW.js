...
import { a as AuthModalProvider, A as AppLayout } from "./AppLayout-drJ3vZBs.js";
...
function Show({ auction, bids, related, highestBid, winnerDetails, isFavorite, dynamicFields = [], liveVideoId = null }) {
  ...
  useEffect(() => {
    ...
    const refreshLiveBids = () => {
      router.reload({
        only: ["auction", "bids", "highestBid", "winnerDetails", "liveVideoId"],
        preserveScroll: true,
        preserveState: true,
        showProgress: false
      });
