    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          displayItems.length > 0 && /* @__PURE__ */ jsx("span", { className: "cart-badge position-absolute top-0 start-100 translate-middle badge rounded-pill", style: { backgroundColor: "#43ACE9", fontSize: "10px", padding: "4px 6px" }, children: displayItems.length })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ jsx("div", { className: "cart-popup-container", children: /* @__PURE__ */ jsxs("div", { className: "cart-popup-content shadow-lg border-0 rounded-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom", children: [
      ...
      loading ? /* @__PURE__ */ jsx("div", { className: "text-center py-5", children: /* @__PURE__ */ jsx(Oval, { height: 40, width: 40, color: "#43ACE9" }) }) : displayItems.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "text-center py-5", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "cart-items-scroll pe-2", style: { maxHeight: "350px", overflowY: "auto" }, children: displayItems.map((item) => /* @__PURE__ */ jsxs("div", { className: "d-flex gap-3 mb-4 last-child-mb-0", children: [
          /* @__PURE__ */ jsx("div", { className: "flex-shrink-0", style: { width: "70px", height: "70px", borderRadius: "12px", overflow: "hidden", border: "1px solid #f0f0f0" }, children: /* @__PURE__ */ jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-grow-1 min-width-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "d-flex justify-content-between align-items-start mb-1", children: [
              /* @__PURE__ */ jsx("h6", { className: "mb-0 fw-bold text-truncate", style: { fontSize: "14px", color: "#23262F" }, children: item.title }),
              /* @__PURE__ */ jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsx("p", { className: "small text-muted mb-1", children: item.variation_name || "Standard" }),
            /* @__PURE__ */ jsxs("div", { className: "d-flex justify-content-between align-items-center", children: [
              /* @__PURE__ */ jsx("span", { className: "fw-bold text-dark", children: /* @__PURE__ */ jsx(Price, { amountAED: item.price }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-4 pt-3 border-top", children: [
...
function DesktopCategoriesDropdown() {
  ...
  useEffect(() => {
    axios.get("/get-category").then((res) => setCategories(
  ...
  const loadSubcategories = async (slug) => {
    ...
    try {
      ...
      setCategories((prev) => prev.map(
        (c) => c.id === cat.id ? { ...c, subcategories: res.data.subcategories || [] } : c
      ));
    } catch (e) {
      console.error(e);
    }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dropdown", ref: dropdownRef, children: [
    ...
    /* @__PURE__ */ jsx("ul", { className: "dropdown-menu", "aria-labelledby": "categoriesDropdown", children: categories.map((cat) => /* @__PURE__ */ jsxs(
      "li",
      {
        ...
        children: [
          ...
          hoveredCat === cat.slug && cat.subcategories.length > 0 && /* @__PURE__ */ jsx("ul", { className: "dropdown-menu sub-menu show", children: cat.subcategories.map((sub) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
            Link,
            {
...
function CategoriesDropdown() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dropdown", children: [
    ...
    /* @__PURE__ */ jsx("ul", { className: "dropdown-menu", "aria-labelledby": "categoriesDropdown", children: categories.map((cat) => /* @__PURE__ */ jsx("li", { className: cat.subCategories?.length ? "dropend" : "", children: cat.subCategories?.length > 0 ? /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsx("ul", { className: "dropdown-menu", children: cat.subCategories.map((sub) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
        Link,
        {
          href: route("marketplace.index", sub.slug),
          className: "dropdown-item",
...
const NotificationDropdown = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "notification-container", children: [
    ...
    isOpen && /* @__PURE__ */ jsxs("div", { className: "notification-popup", ref: notificationRef, style: { position: "absolute", right: 0, top: "100%", zIndex: 1e3, background: "white", border: "1px solid #ddd", minWidth: "300px", boxShadow: "0 4px 12px rgba(0,0,0,0.1)", borderRadius: "8px" }, children: [
      /* @__PURE__ */ jsxs("div", { className: "notification-content p-3 border-bottom d-flex justify-content-between align-items-center", children: [
        /* @__PURE__ */ jsx("h3", { className: "m-0", style: { fontSize: "1rem" }, children: notifications.length > 0 ? "Notifications" : "No new notifications" }),
        notifications.length > 0 && /* @__PURE__ */ jsxs("button", { className: "markAsRead btn btn-link p-0 text-decoration-none", style: { fontSize: "0.8rem" }, onClick: markAllAsRead, children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "notification-body", style: { maxHeight: "300px", overflowY: "auto" }, children: [
        loading && /* @__PURE__ */ jsx("p", { className: "p-3 text-center", children: "Loading notifications..." }),
        !loading && notifications.length === 0 && /* @__PURE__ */ jsx("p", { className: "p-3 text-center", children: "Empty" }),
        !loading && notifications.map((notification) => /* @__PURE__ */ jsx("div", { className: `notification-item p-2 border-bottom ${notification.read_at ? "opacity-50" : ""}`, style: { fontSize: "0.85rem" }, children: /* @__PURE__ */ jsxs("div", { className: "d-flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-grow-1", children: [
            /* @__PURE__ */ jsx("p", { className: "mb-0 fw-bold", children: notification.title }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "d-flex flex-column gap-1", children: [
            ...
            /* @__PURE__ */ jsx("button", { className: "btn btn-sm btn-link p-0", onClick: () => deleteNotification(notification.id), children: /* @__PURE__ */ jsx("i", { className: "fa-solid fa-xmark text-danger" }) })
          ] })
        ] }) }, notification.id))
      ] }),
      /* @__PURE__ */ jsx("div", { className: "notification-footer p-2 text-center border-top", children: /* @__PURE__ */ jsx(Link, { href: "/notifications-page", style: { fontSize: "0.8rem" }, children: "See All Notifications" }) })
    ] })
  ] });
};
    ...
    /* @__PURE__ */ jsx("header", { className: "bg-white ", style: { zIndex: 1050 }, children: /* @__PURE__ */ jsx("nav", { className: "navbar navbar-expand-lg navbar-light bg-white py-2", id: "mainNavbar", children: /* @__PURE__ */ jsxs("div", { className: "container-fluid px-lg-5 my-3", children: [
      ...
      /* @__PURE__ */ jsxs("div", { ref: mobileMenuRef, className: `navbar-collapse xpert-mobile-menu ${isMenuOpen ? "show" : ""}`, id: "navbarSupportedContent", children: [
        /* @__PURE__ */ jsxs("ul", { className: "navbar-nav me-auto mb-2 mb-lg-0 align-items-lg-center", children: [
          ...
          /* @__PURE__ */ jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsx(Link, { href: route("auctions.one_rupee"), className: "nav-link", onClick: closeMobileMenu, children: "1 Rupee Auction" }) }),
          /* @__PURE__ */ jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsx(Link, { href: route("about"), className: "nav-link", onClick: closeMobileMenu, children: "About" }) }),
          /* @__PURE__ */ jsx("li", { className: "nav-item", children: /* @__PURE__ */ jsx(Link, { href: route("contact"), className: "nav-link", onClick: closeMobileMenu, children: "Contact Us" }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "d-flex align-items-center mt-3 mt-lg-0", children: [
          /* @__PURE__ */ jsxs("div", { className: "d-none d-lg-flex align-items-center mt-2", children: [
            /* @__PURE__ */ jsx("div", { className: "me-3", children: /* @__PURE__ */ jsx(CartPopup, {}) }),
            user && /* @__PURE__ */ jsx("div", { className: "ms-3", children: /* @__PURE__ */ jsx(NotificationDropdown, {}) })
          ] }),
          !user ? /* @__PURE__ */ jsxs("div", { className: "registration-btns d-flex align-items-center", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "user-profile-setting-container d-none d-lg-block ms-3", ref: userProfileRefDesktop, children: [
              /* @__PURE__ */ jsxs(
                "button",
                {
              ...
              isUserSettingsOpenDesktop && /* @__PURE__ */ jsx("div", { id: "userProfileSettingPopup", className: "user-profile-setting-popup show", style: { position: "absolute", right: 0, top: "100%" }, children: /* @__PURE__ */ jsx("div", { className: "user-profile-setting-content", style: { padding: "20px" }, children: /* @__PURE__ */ jsxs("ul", { className: "user-setting-menu", style: { paddingLeft: 0, listStyle: "none", marginBottom: 0, width: "100%" }, children: [
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsxs(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: { color: "#24282B", fontFamily: '"Inter", sans-serif' }, href: route("profile.edit"), children: [
                  /* @__PURE__ */ jsx("img", { src: "/assets/images/profile-setting.svg", alt: "Settings", width: 20, height: 20 }),
                  " Account Settings"
                ] }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsxs(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: { color: "#24282B", fontFamily: '"Inter", sans-serif' }, href: route("chat.index"), children: [
                  /* @__PURE__ */ jsx("i", { className: "fa-solid fa-comment-dots text-center", style: { width: "20px", fontSize: "18px" } }),
                  " Messages"
                ] }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsxs(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: { color: "#24282B", fontFamily: '"Inter", sans-serif' }, href: route("favorites.index"), children: [
                  /* @__PURE__ */ jsx("img", { src: "/assets/images/setting-heart.svg", alt: "Favorites", width: 20, height: 20 }),
                  " My Favorites"
                ] }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsxs(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: { color: "#24282B", fontFamily: '"Inter", sans-serif' }, href: route("auctions.mylistings"), children: [
                  /* @__PURE__ */ jsx("img", { src: "/assets/images/mainListing.svg", alt: "Listings", width: 20, height: 20 }),
                  " My Listings"
                ] }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsxs(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: { color: "#24282B", fontFamily: '"Inter", sans-serif' }, href: route("bids.index"), children: [
                  /* @__PURE__ */ jsx("img", { src: "/assets/images/myBids.svg", alt: "Bids", width: 20, height: 20 }),
                  " My Bids"
                ] }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsxs(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: { color: "#24282B", fontFamily: '"Inter", sans-serif' }, href: route("orders.index"), children: [
                  /* @__PURE__ */ jsx("i", { className: "fa-solid fa-box-open text-center", style: { width: "20px", fontSize: "18px" } }),
                  " My Orders"
                ] }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsxs(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: { color: "#24282B", fontFamily: '"Inter", sans-serif' }, href: route("payment_requests.index"), children: [
                  /* @__PURE__ */ jsx("i", { className: "fa-solid fa-money-check text-center", style: { width: "20px", fontSize: "18px" } }),
                  " Payment Request"
                ] }) }),
                /* @__PURE__ */ jsx("li", { style: { borderBottom: "1px solid #EDEDED", padding: "0px 0", fontSize: "16px", fontWeight: "400", lineHeight: "20px", display: "flex", alignItems: "center", gap: "15px" }, children: /* @__PURE__ */ jsxs(Link, { className: "d-flex align-items-center gap-2 text-decoration-none", style: { color: "#24282B", fontFamily: '"Inter", sans-serif' }, href: route("verification.identity"), children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "row ", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "col-xl-4   col-sm-6 footer-child3", children: /* @__PURE__ */ jsxs("div", { className: "footer-menu ps-0 ps-sm-4", children: [
        ...
        /* @__PURE__ */ jsxs("ul", { children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("faq"), children: "FAQ" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("blogs.index"), children: "Blogs" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("about"), children: "About Us" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("contact"), children: " Contact Us" }) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "col-xl-4   col-sm-6 footer-child3 mt-0 mt-sm-3", children: /* @__PURE__ */ jsx("div", { className: "footer-menu ps-0 ps-sm-4 mt-0 mt-sm-5", children: /* @__PURE__ */ jsxs("ul", { children: [
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("refund.policy"), children: "Refund Policy" }) }),
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("shipping.policy"), children: "Shipping Policy" }) }),
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("privacy.policy"), children: "Privacy Policy" }) }),
        /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("terms"), children: "Terms & Conditions" }) })
      ] }) }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mobile-bottom-nav d-lg-none", children: [
      ...
      /* @__PURE__ */ jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsx("i", { className: "fa-solid fa-compass mobile-bottom-nav__icon" }),
            /* @__PURE__ */ jsx("span", { className: "mobile-bottom-nav__label", children: "Explore" })
          ]
        }
      ),
      /* @__PURE__ */ jsxs(
      ...
      isAuthenticated ? /* @__PURE__ */ jsxs("div", { className: "mobile-bottom-nav__item mobile-bottom-nav__profile", ref: menuRef, children: [
        ...
        isUserMenuOpen && /* @__PURE__ */ jsx("div", { className: "mobile-bottom-nav__dropdown shadow", children: /* @__PURE__ */ jsxs("ul", { className: "user-setting-menu list-unstyled m-0 p-0", children: [
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("dashboard"), onClick: () => setIsUserMenuOpen(false), children: "Dashboard" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("chat.index"), onClick: () => setIsUserMenuOpen(false), children: "Messages" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("profile.edit"), onClick: () => setIsUserMenuOpen(false), children: "Settings" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("favorites.index"), onClick: () => setIsUserMenuOpen(false), children: "Favorites" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("auctions.mylistings"), onClick: () => setIsUserMenuOpen(false), children: "My Listings" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("bids.index"), onClick: () => setIsUserMenuOpen(false), children: "My Bids" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("cart.index"), onClick: () => setIsUserMenuOpen(false), children: "My Cart" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, { href: route("orders.index"), onClick: () => setIsUserMenuOpen(false), children: "My Orders" }) }),
          /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("button", { className: "btn btn-link dropdown-item text-danger", onClick: handleLogout, children: "Log Out" }) })
        ] }) })
      ] }) : /* @__PURE__ */ jsxs(
        Link,
        {
