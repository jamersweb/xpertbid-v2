...
import "axios";
function Edit({ slider, categories }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Edit Slider", children: [
    /* @__PURE__ */ jsx(Head, { title: "Edit Slider" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-4xl", children: [
      /* @__PURE__ */ jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxs(Link, { href: route("admin.sliders.index"), className: "text-sm font-bold text-gray-400 hover:text-black transition-colors", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 p-8", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
            /* @__PURE__ */ jsx("p", { className: "text-[10px] text-gray-400 font-bold mb-2 uppercase tracking-wider", children: "Current Image" }),
            /* @__PURE__ */ jsx("img", { src: slider.image || "/images/placeholder.png", className: "w-48 h-24 rounded-xl object-cover border border-gray-100 shadow-sm", alt: "" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-200 border-dashed rounded-xl hover:border-black transition-colors", children: /* @__PURE__ */ jsxs("div", { className: "space-y-1 text-center", children: [
            ...
            /* @__PURE__ */ jsx("input", { type: "file", className: "sr-only", id: "slider-image-edit", onChange: (e) => setData("image", e.target.files[0]) }),
            /* @__PURE__ */ jsx("label", { htmlFor: "slider-image-edit", className: "relative cursor-pointer bg-white rounded-md font-bold text-black hover:text-gray-700", children: /* @__PURE__ */ jsx("span", { children: "Change image" }) }),
        ...
        /* @__PURE__ */ jsx("div", { className: "pt-4", children: /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: processing ? "Saving..." : "Update Slider"
          }
        ) })
      ] }) })
    ] })
