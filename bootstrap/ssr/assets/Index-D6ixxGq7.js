...
function Index({ notifications }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Notifications", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "py-5 bg-light min-vh-100", children: [
      toast.show && /* @__PURE__ */ jsx("div", { className: "notification-toast-wrap", children: /* @__PURE__ */ jsxs("div", { className: `notification-toast notification-toast--${toast.type}`, children: [
        /* @__PURE__ */ jsx("div", { className: "notification-toast__icon", children: toast.type === "success" ? "✓" : "!" }),
        /* @__PURE__ */ jsxs("div", { className: "notification-toast__content", children: [
          /* @__PURE__ */ jsx("div", { className: "notification-toast__title", children: toast.type === "success" ? "Success" : "Error" }),
          /* @__PURE__ */ jsx("div", { className: "notification-toast__message", children: toast.message })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "container", children: /* @__PURE__ */ jsx("div", { className: "row justify-content-center", children: /* @__PURE__ */ jsxs("div", { className: "col-lg-10 col-xl-8", children: [
