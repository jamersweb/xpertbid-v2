...
function JoinLiveButton({ activeSlug }) {
  ...
  return /* @__PURE__ */ jsxs("button", { type: "button", className: `live-auctions-primary ${!activeSlug ? "is-disabled" : ""}`, onClick: handleJoin, disabled: !activeSlug, children: [
    /* @__PURE__ */ jsx("i", { className: "fa-solid fa-bolt" }),
    activeSlug ? "Join Live Auction" : "No Live Auction"
  ] });
}
function LiveAuctionsIndex({ session, activeAuction = null }) {
  ...
  const heroTitle = hasActiveLive ? "Live auction is on" : isComingSoon ? "Live auction coming soon" : isClosed ? "Live auction closed" : "No live auction right now";
  const heroCopy = hasActiveLive ? "Watch the stream, follow the active product, and place bids in real time." : isComingSoon ? scheduledLabel ? `The next live auction is scheduled for ${scheduledLabel}.` : "The next live auction is being prepared. Check back soon." : isClosed && closedLabel ? `This live auction closed ${closedLabel}.` : "Please check back later for the next live auction.";
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Live Auctions | XpertBid", children: [
    /* @__PURE__ */ jsx("main", { className: `live-auctions-page state-${sessionStatus || "idle"}`, children: /* @__PURE__ */ jsxs("section", { className: "live-auctions-hero", children: [
      /* @__PURE__ */ jsxs("div", { className: "live-auctions-hero-copy", children: [
        /* @__PURE__ */ jsxs("span", { className: `live-auctions-kicker ${hasActiveLive ? "is-live" : ""}`, children: [
          /* @__PURE__ */ jsx("i", { className: hasActiveLive ? "fa-solid fa-circle" : "fa-regular fa-circle" }),
          "Live Auction Room"
        ] }),
        /* @__PURE__ */ jsx("h1", { children: heroTitle }),
        /* @__PURE__ */ jsx("p", { children: heroCopy }),
        /* @__PURE__ */ jsxs("div", { className: "live-auctions-actions", children: [
          hasActiveLive ? /* @__PURE__ */ jsx(JoinLiveButton, { activeSlug }) : null,
          isComingSoon ? /* @__PURE__ */ jsx("span", { className: "live-auctions-pill", children: "Starting Soon" }) : null,
          isClosed && closedLabel ? /* @__PURE__ */ jsxs("span", { className: "live-auctions-pill", children: [
            "Closed ",
            closedLabel
          ] }) : null,
          isIdle ? /* @__PURE__ */ jsx("span", { className: "live-auctions-pill", children: "Awaiting Schedule" }) : null
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "live-auctions-feature", children: hasActiveLive || isComingSoon ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("img", { src: liveSetupThumbnail, alt: activeAuction?.title || "Live auction" }),
        /* @__PURE__ */ jsxs("div", { className: "live-auctions-feature-overlay", children: [
          /* @__PURE__ */ jsx("span", { children: hasActiveLive ? "Streaming Now" : "Preview" }),
          /* @__PURE__ */ jsx("i", { className: "fa-solid fa-play" })
        ] })
      ] }) : /* @__PURE__ */ jsxs("div", { className: "live-auctions-empty-feature", children: [
