...
function Setup({ liveAuctions = [] }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Setup Live Auction", children: [
    /* @__PURE__ */ jsx(Head, { title: "Setup Live Auction" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm p-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h1", { className: "text-2xl font-black text-gray-900", children: "Setup Live Auction" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 mt-1", children: "Add YouTube live URL and select the products for the live control room." })
          ] }),
          /* @__PURE__ */ jsx(
            "button",
            {
