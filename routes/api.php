...
Route::prefix('v1')->group(function () {
    ...
    Route::post('/auth/validate-reset-otp', [AuthController::class, 'validateResetOtp']);
    Route::post('/auth/reset-password-phone', [AuthController::class, 'resetPasswordWithPhone']);
